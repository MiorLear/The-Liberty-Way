...
?>
  ...
  <body>
                ...
                ?>
                  ...
                  <li class='nav-item'>
                    ...
                    if ($result['hotel_rooms'] == "ON") { ?>
                      ...
                      <li class="nav-item">
                        <a href="dashboard_hotelroom.php" class="nav-link d-flex align-items-center text-truncate active">
                          <span class="sidebar-icon">
                            <span class="material-symbols-rounded">
                              hotel
                            </span>
              ...
              <div class="row align-items-center position-relative">
                ...
                <div class="col-sm-5 text-md-end">
                  <div class="d-flex justify-content-sm-end align-items-center">
                    ...
                    <a href="dashboard_hotelroom.php" data-tippy-placement="top" data-tippy-content="Reload Dashboard" class="flex-shrink-0 ms-2 p-0 rounded-circle size-35 d-flex align-items-center justify-content-center btn btn-coloruse">
              ...
              <div class="col-12 mb-3 mb-lg-5">
                <div class="overflow-hidden card table-nowrap table-card">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0" style="text-align:center;">New hotel rooms</h5>
                    <a data-bs-target="#createhotelroom" data-bs-toggle="modal" data-tippy-content="Insert a Hotel Room" class="btn btn-outline-secondary btn-sm"><i class="material-symbols-rounded align-middle fs-5">
                        add_circle
                      </i></a>
                  </div>

                  <?php
                  include('../../Includes/Dashboard/hotel/modalshotels/modalinsert.php');
                  ?>
                            ...
                            <tr class="align-middle">
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div>
                                    <div class="h6 mb-0 lh-1"><?php echo $row['hotel'] ?></div>
                                  </div>
                                </div>
                              </td>
                              <td><?php echo $row['adultos'] ?></td>
                              <td><?php echo $row['kids'] ?></td>
                              <td> <span class="d-inline-block align-middle"><?php echo $row['categoria'] ?></span></td>
                                ...
                                <center>
                                  <div class="btn-group btn-group-sm">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                      <button data-bs-target="#updatehotel<?php echo $row['id_hotel'] ?>" data-bs-toggle="modal" data-tippy-content="Update" class="btn btn-outline-warning">
                                        <span class="material-symbols-rounded align-middle me-1">
                                          edit_note
                                        </span>
                                      </button>
                                      <?php
                                      include('../../Includes/Dashboard/hotel/modalshotels/modalupdate.php');
                                      ?>

                                      <button data-bs-target="#deletehotel<?php echo $row['id_hotel'] ?>" data-bs-toggle="modal" data-tippy-content="Delete" class="btn btn-outline-danger">
                                        <span class="material-symbols-rounded align-middle me-1">
                                          delete
                                        </span>
                                      </button>
                                      <?php
                                      include('../../Includes/Dashboard/hotel/modalshotels/modaldelete.php');
                                      ?>
    ...
    ?>
        <script>
          $(function() {
            $('#singleDatePicker<?php echo $row['check_in'] ?>').daterangepicker({
              singleDatePicker: true,
              showDropdowns: true,
              minYear: 2023,
              maxYear: parseInt(moment().format('YYYY'), 10)
        ...
        <script>
          $(function() {
            $('#singleDatePicker<?php echo $row['check_out'] ?>').daterangepicker({
              singleDatePicker: true,
              showDropdowns: true,
              minYear: 2023,
              maxYear: parseInt(moment().format('YYYY'), 10)
