    ...
    <div class="loader bg-gradient-primary text-black">
      <div class="content flex-column p-4 pb-0 d-flex justify-content-center align-items-center flex-column-fluid position-relative">
        <div class="w-100 h-100 position-relative d-flex align-items-center justify-content-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-loader spinner-grow  me-2">
              ...
              <div class="row align-items-center position-relative">
                ...
                <div class="col-sm-5 text-md-end">
                  <div class="d-flex justify-content-sm-end align-items-center">
                    <div class="d-flex align-items-center">
                      <div role="button" id="reportrange" class="btn btn-sm btn-outline-secondary" data-tippy-placement="left" data-tippy-content="Select dashboard data range">
                    ...
                    <a href="index.php" data-tippy-placement="left" data-tippy-content="Reload Dashboard" class="flex-shrink-0 ms-2 p-0 rounded-circle size-35 d-flex align-items-center justify-content-center btn btn-coloruse">
            ...
            <div class="container-fluid px-0">
                          ...
                          <div class="list-group-item p-3 d-flex align-items-center justify-content-between">
                            ...
                            <div class="flex-grow-1 d-flex align-items-center">
                              <div class="flex-grow-1 overflow-hidden">
                                ...
                                <small class="text-body-secondary text-truncate">Flights</small>
                              </div>
                          ...
                          <div class="list-group-item p-3 d-flex align-items-center justify-content-between">
                            ...
                            <div class="flex-grow-1 d-flex align-items-center">
                              <div class="flex-grow-1 overflow-hidden">
                                ...
                                <small class="text-body-secondary text-truncate">Hotel Rooms</small>
                              </div>
                              <div class="flex-shrink-0 ps-2 text-success d-flex align-items-center">
                                <span class="material-symbols-rounded lh-1 align-middle">
                                  arrow_drop_up
                          ...
                          <div class="list-group-item p-3 d-flex align-items-center justify-content-between">
                            ...
                            <div class="flex-grow-1 d-flex align-items-center">
                              <div class="flex-grow-1 overflow-hidden">
                                ...
                                <small class="text-body-secondary text-truncate">Both</small>
                              </div>
                              <div class="flex-shrink-0 ps-2 text-success d-flex align-items-center">
                                <span class="material-symbols-rounded lh-1 align-middle">
                                  arrow_drop_up
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-xl-3 mb-3 mb-lg-5">
                  ...
                  <div class="card card-body">
                    <!--Title-->
                    <h6 class="mb-3">New Flights
                      <span class="material-symbols-rounded ms-2 fs-6 align-middle opacity-75" data-tippy-content="Earnings by sales" data-tippy-placement="top">info</span>
                    </h6>
                    <div class="d-flex lh-1 align-items-center">
                      <h4 class="mb-0">56</h4>
                ...
                <div class="col-lg-7 col-xxl-8 mb-3 mb-lg-5">
                  ...
                  <div class="card table-card table-nowrap overflow-hidden h-100">
                    <div class="d-flex card-header align-items-center justify-content-between">
                      <h5 class="me-3 card-title mb-0">Top Countries</h5>
                      ...
                      <table class="table table-striped mb-0" style="width:100%">
                        ...
                        <tbody class="align-middle">
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <a href="#!.html"><img src="https://cdn.jsdelivr.net/npm/svg-country-flags@1.2.10/svg/us.svg" class="avatar sm bg-body p-1 rounded-2 me-3 align-middle" alt=""></a>
                                <p class="mb-0 text-truncate fs-6"><a href="#!.html" class="text-reset">United States</a></p>
                              </div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="">
                              <div class="d-inline-flex align-items-center">
                                <a href="#!.html"><img src="https://cdn.jsdelivr.net/npm/svg-country-flags@1.2.10/svg/fr.svg" class="avatar sm bg-body p-1 rounded-2 me-3 align-middle" alt=""></a>
                                <p class="mb-0 text-truncate fs-6"><a href="#!.html" class="text-reset">France</a></p>
                              </div>
                            </td>
                            <td>
                              <div class="d-inline-flex badge bg-success-subtle text-success align-items-center">
                          ...
                          <tr>
                            <td class="">
                              <div class="d-inline-flex align-items-center">
                                <a href="#!.html"><img src="https://cdn.jsdelivr.net/npm/svg-country-flags@1.2.10/svg/gb.svg" class="avatar sm bg-body p-1 rounded-2 me-3 align-middle" alt=""></a>
                                <p class="mb-0 text-truncate fs-6"><a href="#!.html" class="text-reset">United Kingdom</a></p>
                              </div>
                            </td>
                            <td>
                              <div class="d-inline-flex badge bg-success-subtle text-success align-items-center">
                          ...
                          <tr>
                            <td class="">
                              <div class="d-inline-flex align-items-center">
                                <a href="#!.html"><img src="https://cdn.jsdelivr.net/npm/svg-country-flags@1.2.10/svg/jp.svg" class="avatar sm bg-body p-1 rounded-2 me-3 align-middle" alt=""></a>
                                <p class="mb-0 text-truncate fs-6"><a href="#!.html" class="text-reset">Japan</a></p>
                              </div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="">
                              <div class="d-inline-flex align-items-center">
                                <a href="#!.html"><img src="https://cdn.jsdelivr.net/npm/svg-country-flags@1.2.10/svg/ca.svg" class="avatar sm bg-body p-1 rounded-2 me-3 align-middle" alt=""></a>
                                <p class="mb-0 text-truncate fs-6"><a href="#!.html" class="text-reset">Canada</a></p>
                              </div>
                            </td>
                            <td>
                              <div class="d-inline-flex badge bg-success-subtle text-success align-items-center">
