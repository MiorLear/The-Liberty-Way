...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,[email protected],400,0,0" /> <!--Uses-->
    ...
    <body>
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="page d-flex flex-row flex-column-fluid">
                ...
                <aside class="page-sidebar">
                  ...
                  <li class='nav-item'>
                    <a href='dashboard_flight.php' class='nav-link d-flex align-items-center text-truncate active'>
                      <span class='sidebar-icon'>
                        <span class='material-symbols-rounded'>
                          airplane_ticket
                        </span>
                        ...
                        <div class="position-relative container-fluid px-0">
                            <div class="row align-items-center position-relative">
                                <div class="col-sm-7 mb-3 mb-sm-0">
                                    ...
                                    <a data-tippy-content="PDF Report" href="../../Includes/Pdf/TLW - UsersReport.php" type="button" class="btn btn-outline-danger"><span class="mb-1 material-symbols-rounded" style="font-size:22px"><span>picture_as_pdf</span></span></a>
                                    &nbsp;
                                ...
                                <div class="col-sm-5 text-md-end">
                                    <div class="d-flex justify-content-sm-end align-items-center">
                                        ...
                                        <a href="dashboard_flight.php" data-tippy-placement="top" data-tippy-content="Reload Dashboard" class="flex-shrink-0 ms-2 p-0 rounded-circle size-35 d-flex align-items-center justify-content-center btn btn-coloruse">
                            ...
                            <div class="col-12 mb-3 mb-lg-5">
                                <div class="overflow-hidden card table-nowrap table-card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">New flights</h5>
                                        <a data-bs-target="#createflight" data-bs-toggle="modal" href="#!" data-tippy-content="Insert a Flight" class="btn btn-outline-secondary btn-sm"><i class="material-symbols-rounded align-middle fs-5">
                                                add_circle
                                            </i></a>
                                    </div>

                                    <?php
                                    include('../../Includes/Dashboard/flights/modalsflights/modalinsert.php');
                                    ?>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr class="align-middle">
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <img src="../../Assets/Dashboard/media/avatars/08.jpg" class="avatar sm rounded-pill me-3 flex-shrink-0" alt="Customer">
                                                                    <div>
                                                                        <div class="h6 mb-0 lh-1"><?php echo $row['aerolinea'] ?></div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $row['tipo_vuelo'] ?></td>
                                                            <td><?php echo $row['categoria_vuelo'] ?></td>
                                                            <td><img src="../../Assets/Dashboard/media/flags/<?php echo strtolower($row['lugar_salida']) ?>.svg" class="width-20 h-auto me-2 rounded-pill align-middle" alt=""> <span class="d-inline-block align-middle"><?php echo $row['lugar_salida'] ?></span></td>
                                                            <td><img src="../../Assets/Dashboard/media/flags/<?php echo strtolower($row['lugar_destino']) ?>.svg" class="width-20 h-auto me-2 rounded-pill align-middle" alt=""> <span class="d-inline-block align-middle"><?php echo $row['lugar_destino'] ?></span></td>
                                                            <td><?php echo $row['fecha_salida'] ?></td>
                                                            <td><?php echo $row['fecha_destino'] ?></td>
                                                                ...
                                                                <center>
                                                                    <div class="btn-group btn-group-sm">
                                                                        ...
                                                                        <div class="d-flex flex-wrap gap-2">
                                                                            <button data-bs-target="#updateflight<?php echo $row['id_vuelo'] ?>" data-bs-toggle="modal" data-tippy-content="Update" class="btn btn-outline-warning">
                                                                                <span class="material-symbols-rounded align-middle me-1">
                                                                                    edit_note
                                                                                </span>
                                                                            </button>
                                                                            <?php
                                                                            include('../../Includes/Dashboard/flights/modalsflights/modalupdate.php');
                                                                            ?>
                                                                            <button data-bs-target="#deleteflight<?php echo $row['id_vuelo'] ?>" data-bs-toggle="modal" data-tippy-content="Delete" class="btn btn-outline-danger">
                                                                                <span class="material-symbols-rounded align-middle me-1">
                                                                                    delete
                                                                                </span>
                                                                            </button>
                                                                            <?php
                                                                            include('../../Includes/Dashboard/flights/modalsflights/modaldelete.php');
                                                                            ?>
                                                                        </div>
                                                                    </div>
                                                                </center>
        ...
        <script>
            $(function() {
                $('#singleDatePicker2').daterangepicker({
                    singleDatePicker: true,
                    showDropdowns: true,
                    minYear: 2023,
                    maxYear: parseInt(moment().format('YYYY'), 10)
        ...
        ?>
                <script>
                    $(function() {
                        $('#singleDatePicker<?php echo $row['fecha_salida'] ?>').daterangepicker({
                            singleDatePicker: true,
                            showDropdowns: true,
                            minYear: 2023,
                            maxYear: parseInt(moment().format('YYYY'), 10)
                ...
                <script>
                    $(function() {
                        $('#singleDatePicker<?php echo $row['fecha_destino'] ?>').daterangepicker({
                            singleDatePicker: true,
                            showDropdowns: true,
                            minYear: 2023,
                            maxYear: parseInt(moment().format('YYYY'), 10)
