                    ...
                    <a href='dashboard_flight.php' class='nav-link d-flex align-items-center text-truncate'>
                      ...
                      <span class='sidebar-text'>Flights</span>
                                        ...
                                        if ($result['users'] == "ON") { ?>
                                            ...
                                            <li class="nav-item">
                                                <a href="dashboard_usuario.php" class="nav-link d-flex align-items-center text-truncate active">
                                                    <span class="sidebar-icon">
                                                        <span class="material-symbols-rounded">
                                                            person_search
                                                        </span>
                            ...
                            <div class="row align-items-center position-relative">
                                ...
                                <div class="col-sm-5 text-md-end">
                                    <div class="d-flex justify-content-sm-end align-items-center">
                                        ...
                                        <a href="dashboard_usuario.php" data-tippy-placement="top" data-tippy-content="Reload Dashboard" class="flex-shrink-0 ms-2 p-0 rounded-circle size-35 d-flex align-items-center justify-content-center btn btn-coloruse">
                            ...
                            <div class="col-12 mb-3 mb-lg-5">
                                <div class="overflow-hidden card table-nowrap table-card">
                                    ...
                                    <div class="table-responsive">
                                        <table id="purchasestable" class="table mb-0">
                                            ...
                                            <tbody>
                                                <?php
                                                if ($_SESSION['id_rol'] == 1) {
                                                    $sql = "SELECT * FROM usuarios WHERE rol= '2' OR rol= '3'";
                                                ...
                                                ?>
                                                            <tr class="align-middle">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    if (strlen($row['imagen']) < 30) { ?>

                                                                        <div class="d-flex align-items-center">

                                                                            <img src="../../Assets/Profile/image/<?php echo $row['imagen'] ?>" class="avatar sm rounded-pill me-3 flex-shrink-0" alt="Customer">
                                                                    ...
                                                                    <?php  } else { ?>
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <img src="<?php echo $row['imagen'] ?>" class="avatar sm rounded-pill me-3 flex-shrink-0" alt="Customer">
                                                                ...
                                                                <td> <span class="d-inline-block align-middle"><?php echo $row['telefono'] ?></span></td>
                                                                <td> <span class="d-inline-block align-middle"><?php echo $row['rol'] ?></span></td>
                                                                <td> <span class="d-inline-block align-middle"><?php echo $row['estado'] ?></span></td>
                                                                <td> <span class="d-inline-block align-middle"><?php echo $row['fecha'] ?></span></td>
                                                                    ...
                                                                    <center>
                                                                        <div class="btn-group btn-group-sm">
                                                                            ...
                                                                            <div class="d-flex flex-wrap gap-2">
                                                                                <button data-bs-target="#updateuser<?php echo $row['id_usuario'] ?>" data-bs-toggle="modal" data-tippy-content="Update" class="btn btn-outline-warning">
                                                                                    <span class="material-symbols-rounded align-middle me-1">
                                                                                        edit_note
                                                                                    </span>
                                                                                </button>
                                                                                <?php
                                                                                include('../../Includes/Dashboard/user/modalusers/modalupdate.php');
                                                                                ?>

                                                                                <button data-bs-target="#deleteuser<?php echo $row['id_usuario'] ?>" data-bs-toggle="modal" data-tippy-content="Delete" class="btn btn-outline-danger">
                                                                                    <span class="material-symbols-rounded align-middle me-1">
                                                                                        delete
                                                                                    </span>
                                                                                </button>
                                                                                <?php
                                                                                include('../../Includes/Dashboard/user/modalusers/modaldelete.php');
                                                                                ?>
