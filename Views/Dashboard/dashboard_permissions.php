...
?>
    ...
    <head>
        ...
        <title>TheLibertyWay - Dashboard</title>
        ...
        <!-- CSS | Airplane Switch -->
        <link rel="stylesheet" href="../../CSS/Switch-Airplane/styles.css" />
    ...
    <body>
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="page d-flex flex-row flex-column-fluid">
                        ...
                        <div class="aside-menu px-3 my-auto" data-simplebar>
                            <nav class="flex-grow-1 h-100" id="page-navbar">
                                ...
                                <ul class="nav flex-column collapse-group collapse d-flex">
                                    ...
                                    <li class="nav-item">
                                        <a href="dashboard_PaymentReceipt.php" class="nav-link d-flex align-items-center text-truncate ">
                                            <span class="sidebar-icon">
                                                <span class="material-symbols-rounded">
                                                    Receipt_Long
                                                </span>
                                    ...
                                    if ($_SESSION['id_rol'] == 1) { ?>
                                        ...
                                        <li class="nav-item">
                                            <a href="dashboard_permissions.php" class="nav-link d-flex align-items-center text-truncate active">
                                                <span class="sidebar-icon">
                                                    <span class="material-symbols-rounded">
                                                        lock
                                                    </span>
                            ...
                            <div class="row align-items-center position-relative">
                                ...
                                <div class="col-sm-5 text-md-end">
                                    <div class="d-flex justify-content-sm-end align-items-center">
                                        ...
                                        <a href="dashboard_permissions.php" data-tippy-placement="top" data-tippy-content="Reload Dashboard" class="flex-shrink-0 ms-2 p-0 rounded-circle size-35 d-flex align-items-center justify-content-center btn btn-coloruse">
                ...
                <div class="content px-3 px-lg-6 pt-3 pb-0 d-flex flex-column-fluid position-relative" style="width: 100%; height: 142px;">
                    <div class="container-fluid px-0" style="text-align: center;">
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">

                            <div class="card overflow-hidden" style="width: 95%;">
                                <div class="card-body">
                                    <span class="align-middle material-symbols-rounded fs-1 mb-2">
                                        airplane_ticket
                                    </span>
                                    <h6 class="fs-4 mb-1">Flights</h6>
                                    <label class="plane-switch">
                                        <?php
                                        $sql = pg_query($conexion, "SELECT * FROM permissions WHERE id_permissions='1'");
                                        while ($datos = pg_fetch_assoc($sql)) {
                                            if ($datos['flights'] == "ON") {
                                                echo "<input id='myCheckbox' type='checkbox' onclick='sendValueToPHP()' checked>";
                                            } elseif ($datos['flights'] == "OFF") {
                                                echo "<input id='myCheckbox' type='checkbox' onclick='sendValueToPHP()'>";
                                            }
                                        } ?>
                                        <div>
                                            <div>
                                    ...
                                    <input id="value" name="value" type="hidden" value="<?php
                                                                                        $sql = pg_query($conexion, "SELECT * FROM permissions WHERE id_permissions='1'");
                                                                                        while ($datos = pg_fetch_assoc($sql)) {
                                                                                            if ($datos['flights'] == "ON") {
                                                                                                echo "ON";
                    ...
                    <div class="card-body">
                      ...
                      <h6 class="fs-4 mb-1">Flights</h6>
                      <label class="plane-switch">
                            <input id="myCheckbox" type="checkbox" onclick="sendValueToPHP()">
                            <div>
                            <div>
                            <svg viewBox="0 0 13 13">
                                <path d="M1.55989957,5.41666667 L5.51582215,5.41666667 L4.47015462,0.108333333 L4.47015462,0.108333333 C4.47015462,0.0634601974 4.49708054,0.0249592654 4.5354546,0.00851337035 L4.57707145,0 L5.36229752,0 C5.43359776,0 5.50087375,0.028779451 5.55026392,0.0782711996 L5.59317877,0.134368264 L7.13659662,2.81558333 L8.29565964,2.81666667 C8.53185377,2.81666667 8.72332694,3.01067661 8.72332694,3.25 C8.72332694,3.48932339 8.53185377,3.68333333 8.29565964,3.68333333 L7.63589819,3.68225 L8.63450135,5.41666667 L11.9308317,5.41666667 C12.5213171,5.41666667 13,5.90169152 13,6.5 C13,7.09830848 12.5213171,7.58333333 11.9308317,7.58333333 L8.63450135,7.58333333 L7.63589819,9.31666667 L8.29565964,9.31666667 C8.53185377,9.31666667 8.72332694,9.51067661 8.72332694,9.75 C8.72332694,9.98932339 8.53185377,10.1833333 8.29565964,10.1833333 L7.13659662,10.1833333 L5.59317877,12.8656317 C5.55725264,12.9280353 5.49882018,12.9724157 5.43174295,12.9907056 L5.36229752,13 L4.57707145,13 L4.55610333,12.9978962 C4.51267695,12.9890959 4.48069792,12.9547924 4.47230803,12.9134397 L4.47223088,12.8704208 L5.51582215,7.58333333 L1.55989957,7.58333333 L0.891288881,8.55114605 C0.853775374,8.60544678 0.798421006,8.64327676 0.73629202,8.65879796 L0.672314689,8.66666667 L0.106844414,8.66666667 L0.0715243949,8.66058466 L0.0715243949,8.66058466 C0.0297243066,8.6457608 0.00275502199,8.60729104 0,8.5651586 L0.00593007386,8.52254537 L0.580855011,6.85813984 C0.64492547,6.67265611 0.6577034,6.47392717 0.619193545,6.28316421 L0.580694768,6.14191703 L0.00601851064,4.48064746 C0.00203480725,4.4691314 0,4.45701613 0,4.44481314 C0,4.39994001 0.0269259152,4.36143908 0.0652999725,4.34499318 L0.106916826,4.33647981 L0.672546853,4.33647981 C0.737865848,4.33647981 0.80011301,4.36066329 0.848265401,4.40322477 L0.89131128,4.45169723 L1.55989957,5.41666667 Z" fill="currentColor"></path>
                    ...
                    <div class="container-fluid px-0" style="text-align: center;">
                        ...
                        <div class="card overflow-hidden" style="width: 95%;">
                            <div class="card-body">
                                ...
                                <h6 class="fs-4 mb-1">Hotel Rooms</h6>
                                <label class="plane-switch">
                                    <?php
                                    $sql = pg_query($conexion, "SELECT * FROM permissions WHERE id_permissions='1'");
                                    while ($datos = pg_fetch_assoc($sql)) {
                                        if ($datos['hotel_rooms'] == "ON") {
                                            echo "<input id='myCheckbox2' type='checkbox' onclick='sendValueToPHP2()' checked>";
                                        } elseif ($datos['hotel_rooms'] == "OFF") {
                                            echo "<input id='myCheckbox2' type='checkbox' onclick='sendValueToPHP2()'>";
                                        }
                                    } ?>

                                    <!-- <input id="myCheckbox2" type="checkbox" onclick="sendValueToPHP2()"> -->
                                    <div>
                                        <div>
                                            <svg viewBox="0 0 13 13">
                                                <path d="M1.55989957,5.41666667 L5.51582215,5.41666667 L4.47015462,0.108333333 L4.47015462,0.108333333 C4.47015462,0.0634601974 4.49708054,0.0249592654 4.5354546,0.00851337035 L4.57707145,0 L5.36229752,0 C5.43359776,0 5.50087375,0.028779451 5.55026392,0.0782711996 L5.59317877,0.134368264 L7.13659662,2.81558333 L8.29565964,2.81666667 C8.53185377,2.81666667 8.72332694,3.01067661 8.72332694,3.25 C8.72332694,3.48932339 8.53185377,3.68333333 8.29565964,3.68333333 L7.63589819,3.68225 L8.63450135,5.41666667 L11.9308317,5.41666667 C12.5213171,5.41666667 13,5.90169152 13,6.5 C13,7.09830848 12.5213171,7.58333333 11.9308317,7.58333333 L8.63450135,7.58333333 L7.63589819,9.31666667 L8.29565964,9.31666667 C8.53185377,9.31666667 8.72332694,9.51067661 8.72332694,9.75 C8.72332694,9.98932339 8.53185377,10.1833333 8.29565964,10.1833333 L7.13659662,10.1833333 L5.59317877,12.8656317 C5.55725264,12.9280353 5.49882018,12.9724157 5.43174295,12.9907056 L5.36229752,13 L4.57707145,13 L4.55610333,12.9978962 C4.51267695,12.9890959 4.48069792,12.9547924 4.47230803,12.9134397 L4.47223088,12.8704208 L5.51582215,7.58333333 L1.55989957,7.58333333 L0.891288881,8.55114605 C0.853775374,8.60544678 0.798421006,8.64327676 0.73629202,8.65879796 L0.672314689,8.66666667 L0.106844414,8.66666667 L0.0715243949,8.66058466 L0.0715243949,8.66058466 C0.0297243066,8.6457608 0.00275502199,8.60729104 0,8.5651586 L0.00593007386,8.52254537 L0.580855011,6.85813984 C0.64492547,6.67265611 0.6577034,6.47392717 0.619193545,6.28316421 L0.580694768,6.14191703 L0.00601851064,4.48064746 C0.00203480725,4.4691314 0,4.45701613 0,4.44481314 C0,4.39994001 0.0269259152,4.36143908 0.0652999725,4.34499318 L0.106916826,4.33647981 L0.672546853,4.33647981 C0.737865848,4.33647981 0.80011301,4.36066329 0.848265401,4.40322477 L0.89131128,4.45169723 L1.55989957,5.41666667 Z" fill="currentColor"></path>
                                ...
                                <input id="value2" name="value2" type="hidden" value="<?php
                                                                                        $sql = pg_query($conexion, "SELECT * FROM permissions WHERE id_permissions='1'");
                                                                                        while ($datos = pg_fetch_assoc($sql)) {
                                                                                            if ($datos['hotel_rooms'] == "ON") {
                                                                                                echo "ON";
                    ...
                    <div class="container-fluid px-0" style="text-align: center;">
                        ...
                        <div class="card overflow-hidden" style="width: 95%;">
                            <div class="card-body">
                                ...
                                <h6 class="fs-4 mb-1">Users</h6>
                                <label class="plane-switch">
                                    <?php
                                    $sql = pg_query($conexion, "SELECT * FROM permissions WHERE id_permissions='1'");
                                    while ($datos = pg_fetch_assoc($sql)) {
                                        if ($datos['users'] == "ON") {
                                            echo "<input id='myCheckbox3' type='checkbox' onclick='sendValueToPHP3()' checked>";
                                        } elseif ($datos['users'] == "OFF") {
                                            echo "<input id='myCheckbox3' type='checkbox' onclick='sendValueToPHP3()'>";
                                        }
                                    } ?>
                                    <!-- <input id="myCheckbox3" type="checkbox" onclick="sendValueToPHP3()"> -->
                                    <div>
                                        <div>
                                            <svg viewBox="0 0 13 13">
                                                <path d="M1.55989957,5.41666667 L5.51582215,5.41666667 L4.47015462,0.108333333 L4.47015462,0.108333333 C4.47015462,0.0634601974 4.49708054,0.0249592654 4.5354546,0.00851337035 L4.57707145,0 L5.36229752,0 C5.43359776,0 5.50087375,0.028779451 5.55026392,0.0782711996 L5.59317877,0.134368264 L7.13659662,2.81558333 L8.29565964,2.81666667 C8.53185377,2.81666667 8.72332694,3.01067661 8.72332694,3.25 C8.72332694,3.48932339 8.53185377,3.68333333 8.29565964,3.68333333 L7.63589819,3.68225 L8.63450135,5.41666667 L11.9308317,5.41666667 C12.5213171,5.41666667 13,5.90169152 13,6.5 C13,7.09830848 12.5213171,7.58333333 11.9308317,7.58333333 L8.63450135,7.58333333 L7.63589819,9.31666667 L8.29565964,9.31666667 C8.53185377,9.31666667 8.72332694,9.51067661 8.72332694,9.75 C8.72332694,9.98932339 8.53185377,10.1833333 8.29565964,10.1833333 L7.13659662,10.1833333 L5.59317877,12.8656317 C5.55725264,12.9280353 5.49882018,12.9724157 5.43174295,12.9907056 L5.36229752,13 L4.57707145,13 L4.55610333,12.9978962 C4.51267695,12.9890959 4.48069792,12.9547924 4.47230803,12.9134397 L4.47223088,12.8704208 L5.51582215,7.58333333 L1.55989957,7.58333333 L0.891288881,8.55114605 C0.853775374,8.60544678 0.798421006,8.64327676 0.73629202,8.65879796 L0.672314689,8.66666667 L0.106844414,8.66666667 L0.0715243949,8.66058466 L0.0715243949,8.66058466 C0.0297243066,8.6457608 0.00275502199,8.60729104 0,8.5651586 L0.00593007386,8.52254537 L0.580855011,6.85813984 C0.64492547,6.67265611 0.6577034,6.47392717 0.619193545,6.28316421 L0.580694768,6.14191703 L0.00601851064,4.48064746 C0.00203480725,4.4691314 0,4.45701613 0,4.44481314 C0,4.39994001 0.0269259152,4.36143908 0.0652999725,4.34499318 L0.106916826,4.33647981 L0.672546853,4.33647981 C0.737865848,4.33647981 0.80011301,4.36066329 0.848265401,4.40322477 L0.89131128,4.45169723 L1.55989957,5.41666667 Z" fill="currentColor"></path>
                                ...
                                <input id="value3" name="value3" type="hidden" value="<?php
                                                                                        $sql = pg_query($conexion, "SELECT * FROM permissions WHERE id_permissions='1'");
                                                                                        while ($datos = pg_fetch_assoc($sql)) {
                                                                                            if ($datos['users'] == "ON") {
                                                                                                echo "ON";
                ...
                <div class="content px-3 px-lg-6 pt-3 pb-0 d-flex flex-column-fluid position-relative" style="width: 100%; height: 142px;">
                    <div class="container-fluid px-0" style="text-align: center; height: 142px;">

                        <!--//Card start//-->
                        <div class="card overflow-hidden" style="width: 96%;">
                            <div class="card-body">
                                <span class="align-middle material-symbols-rounded fs-1 mb-2">
                                    Receipt_Long
                                </span>
                                <h6 class="fs-4 mb-1">Payments</h6>
                                <label class="plane-switch">
                                    <!-- <input id="myCheckbox4" type="checkbox" onclick="sendValueToPHP4()"> -->
                                    <?php
                                    $sql = pg_query($conexion, "SELECT * FROM permissions WHERE id_permissions='1'");
                                    while ($datos = pg_fetch_assoc($sql)) {
                                        if ($datos['payments'] == "ON") {
                                            echo "<input id='myCheckbox4' type='checkbox' onclick='sendValueToPHP4()' checked>";
                                        } elseif ($datos['payments'] == "OFF") {
                                            echo "<input id='myCheckbox4' type='checkbox' onclick='sendValueToPHP4()'>";
                                        }
                                    } ?>
                                    <div>
                                        <div>
                                ...
                                <input id="value4" name="value4" type="hidden" value="<?php
                                                                                        $sql = pg_query($conexion, "SELECT * FROM permissions WHERE id_permissions='1'");
                                                                                        while ($datos = pg_fetch_assoc($sql)) {
                                                                                            if ($datos['payments'] == "ON") {
                                                                                                echo "ON";
                    ...
                    <div class="container-fluid px-0" style="text-align: center;">
                        ...
                        <div class="card overflow-hidden" style="width: 96%;">
                            <div class="card-body">
                                ...
                                <h6 class="fs-4 mb-1">Feedback</h6>
                                <label class="plane-switch">
                                    <?php
                                    $sql = pg_query($conexion, "SELECT * FROM permissions WHERE id_permissions='1'");
                                    while ($datos = pg_fetch_assoc($sql)) {
                                        if ($datos['feedback'] == "ON") {
                                            echo "<input id='myCheckbox5' type='checkbox' onclick='sendValueToPHP5()' checked>";
                                        } elseif ($datos['feedback'] == "OFF") {
                                            echo "<input id='myCheckbox5' type='checkbox' onclick='sendValueToPHP5()'>";
                                        }
                                    } ?>
                                    <!-- <input id="myCheckbox5" type="checkbox" onclick="sendValueToPHP5()"> -->
                                    <div>
                                        <div>
                                            <svg viewBox="0 0 13 13">
                                                <path d="M1.55989957,5.41666667 L5.51582215,5.41666667 L4.47015462,0.108333333 L4.47015462,0.108333333 C4.47015462,0.0634601974 4.49708054,0.0249592654 4.5354546,0.00851337035 L4.57707145,0 L5.36229752,0 C5.43359776,0 5.50087375,0.028779451 5.55026392,0.0782711996 L5.59317877,0.134368264 L7.13659662,2.81558333 L8.29565964,2.81666667 C8.53185377,2.81666667 8.72332694,3.01067661 8.72332694,3.25 C8.72332694,3.48932339 8.53185377,3.68333333 8.29565964,3.68333333 L7.63589819,3.68225 L8.63450135,5.41666667 L11.9308317,5.41666667 C12.5213171,5.41666667 13,5.90169152 13,6.5 C13,7.09830848 12.5213171,7.58333333 11.9308317,7.58333333 L8.63450135,7.58333333 L7.63589819,9.31666667 L8.29565964,9.31666667 C8.53185377,9.31666667 8.72332694,9.51067661 8.72332694,9.75 C8.72332694,9.98932339 8.53185377,10.1833333 8.29565964,10.1833333 L7.13659662,10.1833333 L5.59317877,12.8656317 C5.55725264,12.9280353 5.49882018,12.9724157 5.43174295,12.9907056 L5.36229752,13 L4.57707145,13 L4.55610333,12.9978962 C4.51267695,12.9890959 4.48069792,12.9547924 4.47230803,12.9134397 L4.47223088,12.8704208 L5.51582215,7.58333333 L1.55989957,7.58333333 L0.891288881,8.55114605 C0.853775374,8.60544678 0.798421006,8.64327676 0.73629202,8.65879796 L0.672314689,8.66666667 L0.106844414,8.66666667 L0.0715243949,8.66058466 L0.0715243949,8.66058466 C0.0297243066,8.6457608 0.00275502199,8.60729104 0,8.5651586 L0.00593007386,8.52254537 L0.580855011,6.85813984 C0.64492547,6.67265611 0.6577034,6.47392717 0.619193545,6.28316421 L0.580694768,6.14191703 L0.00601851064,4.48064746 C0.00203480725,4.4691314 0,4.45701613 0,4.44481314 C0,4.39994001 0.0269259152,4.36143908 0.0652999725,4.34499318 L0.106916826,4.33647981 L0.672546853,4.33647981 C0.737865848,4.33647981 0.80011301,4.36066329 0.848265401,4.40322477 L0.89131128,4.45169723 L1.55989957,5.41666667 Z" fill="currentColor"></path>
                                ...
                                <input id="value5" name="value5" type="hidden" value="<?php
                                                                                        $sql = pg_query($conexion, "SELECT * FROM permissions WHERE id_permissions='1'");
                                                                                        while ($datos = pg_fetch_assoc($sql)) {
                                                                                            if ($datos['feedback'] == "ON") {
                                                                                                echo "ON";
                ...
                <div class="content px-3 px-lg-6 pt-3 pb-0 d-flex flex-column-fluid position-relative" style="width: 100%;">

                    <div class="container-fluid px-0" style="text-align: center;">
                        <!-- //Card start// -->
                        <div class="card overflow-hidden" style="width: 98%;">
                            <div class="card-body">
                                <button data-tippy-content="Save Changes" name="save_permissions" class="btn btn-outline-primary">
                                    <span class="align-middle material-symbols-rounded fs-1 mb-2">
                                        save
                                    </span>
                                </button>
                        ...
                        if (isset($_POST['save_permissions'])) {
                            ...
                            $sql = "UPDATE permissions SET flights='$value1', hotel_rooms='$value2', users='$value3', payments='$value4', feedback='$value5' WHERE id_permissions='1'";
                            ...
                            if (pg_query($conexion, $sql)) {
                                ...
                                $_SESSION['alerta'] = array(
                                    ...
                                    'text' => 'Successfully updated permissions!'
                                );

                                header("Location: ../../Views/Dashboard/dashboard_permissions.php");
                            } else {
                                $_SESSION['alerta'] = array(
                                    'icon' => 'error',
        ...
        <!-- Airplane-Switch -->
        <script src="../../Includes/Dashboard/permissions/modalpermissions/script.js"></script>
        ...
        <!-- Dropzone File -->
        <script src="../../Assets/Dashboard/vendor/dropzone.min.js"></script>
        <script>
