                    ...
                    <a href='dashboard_flight.php' class='nav-link d-flex align-items-center text-truncate'>
                      ...
                      <span class='sidebar-text'>Flights</span>
                                        ...
                                        if ($result['feedback'] == "ON") { ?>
                                            ...
                                            <li class="nav-item">
                                                <a href="dashboard_feedback.php" class="nav-link d-flex align-items-center text-truncate active">
                                                    <span class="sidebar-icon">
                                                        <span class="material-symbols-rounded">
                                                            comment
                                                        </span>
                        ...
                        <div class="position-relative container-fluid px-0">
                            <div class="row align-items-center position-relative">
                                <div class="col-sm-7 mb-3 mb-sm-0">
                                    ...
                                    <a data-tippy-content="PDF Report" href="../../Includes/Pdf/TLW - FeedbackReport.php" type="button" class="btn btn-outline-danger"><span class="mb-1 material-symbols-rounded" style="font-size:22px"><span>picture_as_pdf</span></span></a>
                                    &nbsp;
                                ...
                                <div class="col-sm-5 text-md-end">
                                    <div class="d-flex justify-content-sm-end align-items-center">
                                        ...
                                        <a href="dashboard_feedback.php" data-tippy-placement="top" data-tippy-content="Reload Dashboard" class="flex-shrink-0 ms-2 p-0 rounded-circle size-35 d-flex align-items-center justify-content-center btn btn-coloruse">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr class="align-middle">
                                                            ...
                                                            <td> <span class="d-inline-block align-middle"><?php echo $row['message'] ?></span></td>
                                                                ...
                                                                <center>
                                                                    <div class="btn-group btn-group-sm">
                                                                        ...
                                                                        <div class="d-flex flex-wrap gap-2">
                                                                            ...
                                                                            <button data-bs-target="#updatefeedback<?php echo $row['id_feedback'] ?>" data-bs-toggle="modal" data-tippy-content="Update" class="btn btn-outline-warning">
                                                                                <span class="material-symbols-rounded align-middle me-1">
                                                                                    edit_note
                                                                                </span>
                                                                            </button>
                                                                            <?php
                                                                            include('../../Includes/Dashboard/feedback/modalfeedback/acceptfeedback.php');
                                                                            ?>

                                                                            <button data-bs-target="#cancelfeedback<?php echo $row['id_feedback'] ?>" data-bs-toggle="modal" data-tippy-content="Delete" class="btn btn-outline-danger">
                                                                                <span class="material-symbols-rounded align-middle me-1">
                                                                                    delete
                                                                                </span>
                                                                            </button>
                                                                            <?php
                                                                            include('../../Includes/Dashboard/feedback/modalfeedback/cancelfeedback.php');
                                                                            ?>
