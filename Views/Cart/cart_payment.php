...
include('../../Includes/Apis/PayPal-api/paypal-config.php');
session_start();
...
<head>
    ...
    <!-- ----- PayPal ----- -->
    <script src="https://www.paypal.com/sdk/js?client-id=<?php echo CLIENT_ID; ?>&currency=<?php echo CURRENCY; ?>&locale=<?php echo LOCALE; ?>"></script>
...
<body>
                                ...
                                <div class="navbar-collapse" id="navbarSupportedContent">
                                    <ul class="" style="padding-top: 25px;">
                                        <li class="menu_has_children">
                                            <a href="cart_checkout.php"><i class="fa-solid fa-chevron-left fa-xl" style="color: #dcbb87;"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
                                            ...
                                            <tbody style="vertical-align: middle; text-align: center;">
                                                ...
                                                ?>
                                                        <tr style="vertical-align: middle; text-align: center;">
                                                            ...
                                                            <td>
                                                                <div class="minimal-input"><?php echo $cantidad; ?></div>
                                                            </td>
                                                            <td>
    ...
    <?php
    $TotalPrice = $total;
    $jsCode = "var TotalPrice = " . $TotalPrice . ";";
    echo '<script>' . $jsCode . '</script>';
    ?>

    <script src="../../Includes/Apis/PayPal-api/paypal.js"></script>
