                  ...
                  <li class="nav-item">
                    ...
                    <ul id="component-forms" class="sidebar-dropdown list-unstyled collapse show">
                      ...
                      <li class="sidebar-item"><a class="sidebar-link @@form_upload" href="ui-form-upload.php">
                          Upload</a></li>
                      <li class="sidebar-item"><a class="sidebar-link active" href="ui-form-daterange-picker.php">
     ...
     <script>
        $(function () {
          ...
          function cb(start, end) {
            $('#predefineRange span').php(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
          }
