                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-components" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link active" href="ui-component-badges.php">Badges</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3 mb-lg-5">
                                    <div class="card overflow-hidden">
                                        ...
                                        <div class="card-body">
                                            <a class="badge bg-primary-subtle text-primary" href="#!">Primary</a>
                                            <a class="badge bg-secondary-subtle text-secondary" href="#!">Secondary</a>
                                            <a class="badge bg-success-subtle text-success" href="#!">Success</a>
                                            <a class="badge bg-danger-subtle text-danger" href="#!">Danger</a>
                                            <a class="badge bg-warning-subtle text-warning" href="#!">Warning</a>
                                            <a class="badge bg-info-subtle text-info" href="#!">Info</a>
                                            <a class="badge bg-light text-dark" href="#!">Light</a>
                                            <a class="badge bg-dark-subtle text-dark" href="#!">Dark</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 mb-3 mb-lg-5">
                                    <div class="card overflow-hidden">
                                        ...
                                        <div class="card-body">
                                            <a class="btn btn-primary me-3" href="#!">
                                                Notifications <span class="badge bg-white text-primary ms-2">99</span>
                                            </a>
                                            <a class="btn btn-danger position-relative p-0 rounded-circle size-40 justify-content-center align-items-center d-inline-flex" href="#!">
                                                <span class="material-symbols-rounded align-middle">
                                                    notifications
                                                  </span>   <span class="badge bg-dark mt-1 ms-n1 position-absolute start-100 top-0 translate-middle rounded-pill">4</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
