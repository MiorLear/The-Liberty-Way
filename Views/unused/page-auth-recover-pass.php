                            ...
                            <div class="row h-100 align-items-center justify-content-center">
                                <div class="col-md-8 col-lg-5 col-xl-4">
                                    ...
                                    <div class="card card-body border-0 shadow-lg p-4">
                                        <h4 class="mb-1">Password recover</h4>
                                        <p class="mb-4 text-body-secondary">
                                            Enter your email to get a password reset link.
                                        </p>
                                        <form class=" z-1 position-relative needs-validation" novalidate="">
                                            ...
                                            <p class="text-body-secondary mb-0">
                                                Remember your password? <a href="page-auth-signin.php"
                                                    class="ms-2">Sign In</a>
