...
<html lang="en">
                      ...
                      <nav class="flex-grow-1 h-100" id="page-navbar">
                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-pages" class="sidebar-dropdown list-unstyled collapse calendars_collapse">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link calendar_search" href="page-search.php">Search</a></li>
                              <li class="sidebar-item"><a class="sidebar-link calendar_invoice" href="page-invoice.php">Invoice</a></li>
                              <li class="sidebar-item"><a class="sidebar-link calendar_tasks" href="page-tasks.php">Tasks</a></li>
                              <li class="sidebar-item"><a class="sidebar-link calendar_pricing" href="page-pricing.php">Pricing</a></li>
                              <li class="sidebar-item">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link calendar_404" href="page-404.php">404 Error</a></li>
                              <li class="sidebar-item"><a class="sidebar-link calendar_blank" href="page-blank.php">Blank Page</a></li>
                            </ul>
                          </li>
    ...
    const exampleEvents = [{
      ...
      },
      {
        ...
        backgroundColor: utils.getColor('danger'),
      ...
      },
      {
        ...
        backgroundColor:utils.getColor('primary'),
        borderColor: utils.getColor('primary'),
      },
      {
        title: 'Lunch',
        start: `${currentYear}-${currentMonth}-04T13:00:00+00:00`,
        backgroundColor:utils.getColor('gray-300'),
      ...
      },
      {
        ...
        borderColor: utils.getColor('gray-400'),
      },
      {
        url: 'http:\/\/google.com\/',
        title: 'google.com',
