...
<html lang="en">
    ...
    <head>
        ...
        <!--dropzone-->
        <link rel="stylesheet" href="../../Assets/Dashboard/vendor/css/dropzone.min.css">
                      ...
                      <nav class="flex-grow-1 h-100" id="page-navbar">
                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-pages" class="sidebar-dropdown list-unstyled collapse chats_collapse">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link chat_search" href="page-search.php">Search</a></li>
                              <li class="sidebar-item"><a class="sidebar-link chat_invoice" href="page-invoice.php">Invoice</a></li>
                              <li class="sidebar-item"><a class="sidebar-link chat_tasks" href="page-tasks.php">Tasks</a></li>
                              <li class="sidebar-item"><a class="sidebar-link chat_pricing" href="page-pricing.php">Pricing</a></li>
                              <li class="sidebar-item">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link chat_404" href="page-404.php">404 Error</a></li>
                              <li class="sidebar-item"><a class="sidebar-link chat_blank" href="page-blank.php">Blank Page</a></li>
                            </ul>
                          </li>
                        ...
                        <div class="content shadow-lg content-wrapper content-expand-md">
                                    ...
                                    <div class="content-sidebar-body p-0 card-body">
                                        <div class="list-group list-group-flush mb-0">
                                            ...
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <div class="d-flex overflow-hidden">
                                                        <h6 class="mb-0 flex-grow-1 text-truncate pe-4">Adam Voges
                                                            <!--New message badge-->
                                                            <span
                                                                class="ms-1 badge rounded-pill bg-primary size-5 p-0 d-inline-block"></span>
                                                        </h6>
                                                        <small class="opacity-75 d-block flex-shrink-0 ms-auto small">12:24 PM</small>
                                                    </div>
                                            ...
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <div class="d-flex overflow-hidden">
                                                        <h6 class="mb-0 text-reset text-truncate pe-3 flex-grow-1">Jason Doe</h6>
                                                        <small class="d-block flex-shrink-0 opacity-75 ms-auto">08:24 AM</small>
                                                    </div>
                                                    <p class="mb-0 text-truncate">
                                            ...
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <div class="d-flex overflow-hidden">
                                                        <h6 class="mb-0 text-reset text-truncate pe-3 flex-grow-1">Dwayne Bravo
                                                        </h6>
                                                        <small class="d-block flex-shrink-0 opacity-75 ms-auto">21/07/21</small>
                                                    </div>
                                            ...
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <div class="d-flex overflow-hidden">
                                                        <h6 class="mb-0 text-reset text-truncate pe-3 flex-grow-1">Nikita Miller
                                                        </h6>
                                                        <small class="d-block flex-shrink-0 opacity-75 ms-auto">07/0721</small>
                                                    </div>
                                                    <p class="mb-0 opacity-75 text-truncate">
                                            ...
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <div class="d-flex overflow-hidden">
                                                        <h6 class="mb-0 text-reset text-truncate pe-3 flex-grow-1">Dylan Ambrose
                                                        </h6>
                                                        <small class="d-block flex-shrink-0 opacity-75 ms-auto">03/06/21</small>
                                                    </div>
                                                    <p class="mb-0 opacity-75 text-truncate">
                                            ...
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <div class="d-flex overflow-hidden">
                                                        <h6 class="mb-0 text-reset text-truncate pe-3 flex-grow-1">Abriella Bond
                                                        </h6>
                                                        <small class="d-block flex-shrink-0 opacity-75 ms-auto">21/04/21</small>
                                                    </div>
                                                    <p class="mb-0 opacity-75 text-truncate">
                            ...
                            <div class="content-right card align-items-stretch h-100">
                                ...
                                <div class="content-right-header card-header px-3">
                                    ...
                                    <!--Buttons group-->
                                    <div class="btn-group btn-group-icon btn-group-sm" role="group" aria-label="Button group with nested dropdown">
                                        <a href="#!" class="btn btn-outline-secondary">
                                            <span class="material-symbols-rounded align-middle fs-4 lh-1">
                                                videocam
                                                </span>
                                        </a>
                                        <a href="#!" class="btn btn-outline-secondary">
                                        ...
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="#" data-bs-toggle="dropdown" class="btn dropdown-toggle btn-outline-secondary"
                                                aria-expanded="false">
                                                <span class="material-symbols-rounded align-middle fs-4 lh-1">
                                                    more_vert
                                                    </span>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end mt-1">
                                                <a href="#!.php" class="dropdown-item">
                                                    <span class="material-symbols-rounded align-middle me-2 opacity-50">
                                                        account_circle
                                                        </span>
                                                        Sender's profile</a>
                                                <a href="#!.php" class="dropdown-item">
