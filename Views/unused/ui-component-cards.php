                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-components" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link active" href="ui-component-cards.php">Cards</a></li>
                    ...
                    <div class="content pt-3 px-3 px-lg-6 d-flex flex-column-fluid">
                        <div class="container-fluid px-0">
                            <div class="row">
                                    ...
                                    <div class="card overflow-hidden">
                                        <div class="card-header d-flex align-items-center">
                                            ...
                                            <div class="flex-shrink-0 ms-auto">
                                                <div class="position-relative">
                                                    <i
                                                        class="material-symbols-rounded fs-5 position-absolute start-0 top-50 opacity-50 ms-2 translate-middle-y">search</i>
                                                    <input type="text" placeholder="Search..."
                                                        class="form-control ps-6 rounded-pill form-control-sm">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body" style="min-height: 5rem;">
                                        ...
                                        <div class="card-header d-flex align-items-center">
                                            ...
                                            <div class="flex-shrink-0 ms-auto">
                                                <div class="btn-group btn-group-sm">
                                                  ...
                                                  <button type="button" class="btn btn-outline-secondary">Last Week</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body" style="min-height: 5rem;">
                                ...
                                <div class="col-lg-6 mb-3 mb-lg-5">
                                    <div class="card bg-primary text-white border-0 overflow-hidden h-100">
                                        <div class="card-header bg-dark bg-opacity-25 border-0 d-flex align-items-center">
                                            <h5 class="mb-0">Colored Title</h5>
                                        </div>
                                        <div class="card-body" style="min-height: 5rem;">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                        </div>
                                ...
                                <div class="col-lg-6 mb-3 mb-lg-5">
                                    <div class="card border border-secondary overflow-hidden h-100">
                                        <div class="card-header bg-secondary text-white d-flex align-items-center">
                                            <h5 class="mb-0">Custom Outline Title</h5>
                                        </div>
                                        <div class="card-body" style="min-height: 5rem;">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                        </div>
                                ...
                                <div class="col-lg-6 mb-3 mb-lg-5">
                                    <div class="card border border-success overflow-hidden h-100">
                                        <div class="card-header border-success d-flex align-items-center">
                                            <h5 class="mb-0">Outline Title</h5>
                                        </div>
                                        <div class="card-body" style="min-height: 5rem;">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                        </div>
                                ...
                                <div class="col-lg-6 mb-3 mb-lg-5">
                                    <div class="card bg-transparent overflow-hidden h-100">
                                        <div class="card-header d-flex align-items-center">
                                            <h5 class="mb-0">Trasparent Body</h5>
                                        </div>
                                        <div class="card-body" style="min-height: 5rem;">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                        </div>
                                ...
                                <div class="col-lg-6 mb-3 mb-lg-5">
                                    <div class="card bg-transparent border shadow-none overflow-hidden h-100">
                                        <div class="card-header bg-transparent d-flex align-items-center">
                                            <h5 class="mb-0">Trasparent All</h5>
                                        </div>
                                        <div class="card-body" style="min-height: 5rem;">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                        </div>
                                ...
                                <div class="col-lg-12 mb-3 mb-lg-5">
                                    <div class="card shadow-none overflow-hidden">
                                        <div class="card-header border-0 bg-transparent d-flex align-items-center">
                                            <h5 class="mb-0 pe-3 text-truncate flex-grow-1">Collapsible</h5>
                                            <span aria-expanded="true" class="card-collapse-btn btn btn-outline-secondary p-0 size-35 rounded-pill d-flex align-items-center justify-content-center" role="button" data-bs-toggle="collapse" data-bs-target="#card_collapsible">
                                                <span class="material-symbols-rounded align-middle">expand_more</span>
                                            </span>
                                        </div>
                                        <div class="collapse show" id="card_collapsible">
                                ...
                                <div class="col-lg-12 mb-3 mb-lg-5">
                                    <div class="card overflow-hidden">
                                        <div class="card-header">
                                            <h5 class="mb-0">Card Tabs</h5>
                                        </div>
                                            <ul class="nav bg-body nav-overflow nav-tabs">
                                                <li class="nav-item ps-4 d-flex">
                                                    <a href="#tab1" class="nav-link active text-truncate" aria-expanded="true"
                                                        data-bs-toggle="tab">Today</a>
                                                </li>
                                                <li class="nav-item d-flex">
                                                    <a href="#tab2" class="nav-link text-truncate" aria-expanded="false"
                                                        data-bs-toggle="tab">Last 7 Days</a>
                                                </li>
                                                <li class="nav-item d-flex">
                                                    <a href="#tab3" class="nav-link text-truncate" aria-expanded="false"
                                                        data-bs-toggle="tab">Last Month</a>
                                                </li>
                                                <li class="nav-item d-flex">
                                                    <a href="#tab4" class="nav-link text-truncate" aria-expanded="false"
                                                        data-bs-toggle="tab">Last Year</a>
                                                </li>
                                            </ul>
                                        <div class="card-body" style="min-height: 5rem;">
