                ...
                <ul class="nav flex-column collapse-group collapse d-flex">
                  ...
                  <li class="nav-item">
                    ...
                    <ul id="component-forms" class="sidebar-dropdown list-unstyled collapse show">
                      ...
                      <li class="sidebar-item"><a class="sidebar-link active" href="ui-form-validation.php">
                          Validation</a></li>
            ...
            <div class="container-fluid px-0">
              <div class="card mb-3 mb-lg-5">
                <div class="card-header d-flex align-items-center">
                  ...
                  <div class="ms-auto">
                    <a href="https://jqueryvalidation.org/" target="_blank" class="text-body">Learn more
                ...
                <div class="card-body py-5">
                  <form id="signupForm">
                    <div class="row mb-4">
                      <label class="col-md-4 text-md-end" for="firstname">First name</label>
                    ...
                    <div class="row mb-4">
                      <label class="col-md-4 text-md-end" for="lastname">Last name</label>
                      <div class="col-md-8 col-lg-6">
                        <div>
                    ...
                    <div class="row mb-4">
                      <label class="col-md-4 text-md-end" for="username">Username</label>
                      <div class="col-md-8 col-lg-6">
                        <div>
                    ...
                    <div class="row mb-4">
                      <label class="col-md-4 text-md-end" for="email">Email</label>
                      <div class="col-md-8 col-lg-6">
                        <div>
                    ...
                    <div class="row mb-4">
                      <label class="col-md-4 text-md-end" for="password">Password</label>
                      <div class="col-md-8 col-lg-6">
                        <div>
                    ...
                    <div class="row mb-4">
                      <label class="col-md-4 text-md-end" for="confirm_password">Confirm password</label>
                      <div class="col-md-8 col-lg-6">
                        <div>
                    ...
                    <div class="row mb-4">
                      <div class="col-md-8 col-lg-6 offset-md-4">
                        <div class="form-check">
                          <input id="jpolicy" name="agree" type="checkbox" class="form-check-input">
                          <label for="jpolicy" class="form-check-label">Please agree to our policy</label>
                        </div>
                      </div>
                    </div>
                    <div class="row">
...
<script src="../../Assets/Dashboard/vendor/jquery.validate.min.js"></script>
    <script>
      ...
      $(document).ready(function () {
        $("#signupForm").validate({
          ...
          errorPlacement: function (error, element) {
            error.addClass("px-3 py-1 bg-danger text-white rounded-2 invalid-feedback");
