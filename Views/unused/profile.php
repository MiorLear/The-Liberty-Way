                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-pages" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item">
                                <a href="#pages-profile" data-bs-toggle="collapse" aria-expanded="false" class="sidebar-link active">
                                  Profile
                                </a>
                                <ul id="pages-profile" class="sidebar-dropdown list-unstyled collapse sd-second-level show">
                                  <li class="sidebar-item">
                                    <a class="sidebar-link active" href="profile.php">Overview</a>
                                  </li>
                                </ul>
                              </li>
                              <li class="sidebar-item">
                    ...
                    <div class="content d-flex flex-column-fluid">
                        <div class="container-fluid px-0">
                            ...
                            <div class="pt-3 px-3 px-lg-6 overflow-hidden">
                                <img src="assets/media/cover/2.jpg" class="img-fluid rounded mb-3 mb-lg-0 shadow-lg"
                                    alt="">
                                <div class="row align-items-lg-end align-items-center mx-lg-0 mb-4 mb-lg-0">
                                    <div class="col-auto px-lg-5">
                                        <!-- Avatar -->
                                        <div
                                            class="avatar xxl rounded bg-body overflow-hidden position-relative mt-lg-n5">
                                    ...
                                    <div class="col mb-3 px-lg-5">
                                        <div class="row align-items-md-end">
                                            <div class="col-12 col-md">
                                                ...
                                                <!-- Profile Subtitle -->
                                                <span class="text-body-secondary small d-block pt-3 mb-1">
                                                    Member Since 2014
                                                </span>
                                ...
                                <div class="pt-md-3">
                                    ...
                                    <ul class="nav mb-3 nav-tabs nav-overflow">
                                        <li class="nav-item">
                                            <a href="#!profile-feed.php" class="nav-link active">
                                                Feed
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#!profile-friends.php" class="nav-link">
                                                Friends
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="#!profile-photos.php" class="nav-link">
                                                Photos
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#!profile-followers.php" class="nav-link">
                                                Followers
                                            </a>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <p class="mb-0"> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ccb5a3b9bea1ada5a08cb5a3b9bea8a3ada1a5a2e2afa3a1">[email&#160;protected]</a> </p>
                                                    </div>
                                                    <div class="mt-3">
                                                        <div class="mb-1 small text-body-secondary">
                                                            <span
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="row g-2 align-items-center">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <small><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2e4347424f404f6e434f4742004d4143">[email&#160;protected]</a></small>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <div class="dropdown">
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="row g-2 align-items-center">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <small><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="aac6cbd8d8d3eac7cbc3c684c9c5c7">[email&#160;protected]</a></small>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <div class="dropdown">
                                                                        <a href="#" class="btn p-1 btn-outline-secondary"
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="row g-2 align-items-center">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <small><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b6ddd9d4c4cfd8f6dbd7dfda98d5d9db">[email&#160;protected]</a></small>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <div class="dropdown">
                                                                        <a href="#" class="btn p-1 btn-outline-secondary"
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="row g-2 align-items-center">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <small><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="badbd6d3c9dbfad7dbd3d694d9d5d7">[email&#160;protected]</a></small>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <div class="dropdown">
                                                                        <a href="#" class="btn p-1 btn-outline-secondary"
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="row g-2 align-items-center">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <small><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="610304020a18210c00080d4f020e0c">[email&#160;protected]</a></small>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <div class="dropdown">
                                                                        <a href="#" class="btn p-1 btn-outline-secondary"
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="row g-2 align-items-center">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <small><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="86e7e7efe2e3e8c6ebe7efeaa8e5e9eb">[email&#160;protected]</a></small>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <div class="dropdown">
                                                                        <a href="#" class="btn p-1 btn-outline-secondary"
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-start align-items-center mb-3">
                                                        ...
                                                        <div class="ps-3">
                                                            ...
                                                            <small class="text-body-subtle">04 August 2021 at 11:03 AM</small>
                                                        </div>
                                                    </div>
                                                    <p>
                                                    ...
                                                    <!--Reaction list-->
                                                     ...
                                                     <a href="#!"
                                                         class="d-flex me-1 align-items-center">
                                                         <span class="me-1">
                                                             <span
                                                                ...
                                                                <div>
                                                                    <div class="py-2 mb-1 px-3 bg-body rounded-3">
                                                                        <div class="d-flex justify-content-between">
                                                                            <h6 class="mb-0">Noah Pierre</h6>
                                                                            <small class="text-body-secondary">12:43 PM</small>
                                                                        </div>
                                                                        <p class="mb-0">
                                            ...
                                            <div class="card mb-3 mb-lg-5">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-start align-items-center mb-3">
                                                        ...
                                                        <div class="ps-3">
                                                            <h6 class="mb-0">Noah Pierre</h6>
                                                            <small class="text-body-secondary">12 August 2021 at 13:43 PM</small>
                                                        </div>
                                                    </div>
                                                    <p>
                                                        Lorem ipsum, or lipsum as it is sometimes known, is dummy text
                                            ...
                                            <div class="card mb-3 mb-lg-5">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-start align-items-center mb-3">
                                                        ...
                                                        <div class="ps-3">
                                                            <h6 class="mb-0">Noah Pierre</h6>
                                                            <small class="text-body-secondary">16 August 2021 at 9:43 AM</small>
                                                        </div>
                                                    </div>
                                                    <p>
                                                        Lorem ipsum, or lipsum as it is sometimes known, is dummy text
                                                    ...
                                                    <!--Comments list-->
                                                    <ul class="list-group">
                                                        <li class="list-group-item text-body-secondary">No Comments</li>
                                                        <li class="list-group-item bg-body">
                                                            <!--Add comment-->
                                                            <h6>Add new comment</h6>
                                                            <form action="#!">
