...
<html lang="en">
    ...
    <body class="layout-boxed bg-gradient-dark">
        <!--Vector gradient-->
        <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" class="position-fixed start-0 top-0 w-100 h-100" viewBox="0 0 700 700" width="700" height="700"><defs><linearGradient gradientTransform="rotate(194, 0.5, 0.5)" x1="50%" y1="0%" x2="50%" y2="100%" id="ffflux-gradient"><stop stop-color="hsl(338, 82%, 49%)" stop-opacity="1" offset="0%"></stop><stop stop-color="hsl(227, 100%, 50%)" stop-opacity="1" offset="100%"></stop></linearGradient><filter id="ffflux-filter" x="-20%" y="-20%" width="140%" height="140%" filterUnits="objectBoundingBox" primitiveUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        ...
        <!--App Start-->
        <div class="d-flex z-1 flex-column flex-root bg-body shadow-lg overflow-hidden">
            <!--Page-->
            <div class="page d-flex flex-row flex-column-fluid">
                <!--///////////Page sidebar begin///////////////-->
                      ...
                      <nav class="flex-grow-1 h-100" id="page-navbar">
                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-pages" class="sidebar-dropdown list-unstyled collapse layoutss_collapse">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link layouts_search" href="page-search.php">Search</a></li>
                              <li class="sidebar-item"><a class="sidebar-link layouts_invoice" href="page-invoice.php">Invoice</a></li>
                              <li class="sidebar-item"><a class="sidebar-link layouts_tasks" href="page-tasks.php">Tasks</a></li>
                              <li class="sidebar-item"><a class="sidebar-link layouts_pricing" href="page-pricing.php">Pricing</a></li>
                              <li class="sidebar-item">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link layouts_404" href="page-404.php">404 Error</a></li>
                              <li class="sidebar-item"><a class="sidebar-link layouts_blank" href="page-blank.php">Blank Page</a></li>
                            </ul>
                          </li>
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="layouts" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link active" href="layout-boxed.php">Boxed</a></li>
                            </ul>
                          </li>
                          <li class="nav-item">
                ...
                <main class="page-content d-flex flex-column flex-row-fluid">
                    ...
                    <div class="content pt-3 px-3 px-lg-6 d-flex flex-column-fluid">
                        <div class="container-fluid px-0">
                          <p class="text-body-secondary">Add class <code>layout-boxed</code> to body tag to get boxed layout</p>
                        </div>
                    </div>
                    <!--//Page content End//-->
