                        ...
                        <div class="position-relative container-fluid px-0">
                            <div class="row align-items-center position-relative">
                                <div class="col-md-8 mb-3 mb-lg-0">
                                    ...
                                    <p class="mb-0">Update and manage your account</p>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <ul class="nav nav-tabs nav-vertical nav-pills mb-3 mb-lg-5 h-100">
                                        ...
                                        <li class="nav-item">
                                            <a href="account-billing.php" class="nav-link px-3">
                                                <span class="material-symbols-rounded me-2 align-middle">
                                                    payments
                                                </span>Billing
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a href="account-contacts.php" class="nav-link active px-3">
                                                <span class="material-symbols-rounded me-2 align-middle">
                                                    groups
                                                </span>Contacts
                                            </a>
                                ...
                                <div class="col-lg-9 h-100">
                                    <div class="row">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <a href="#!"
                                                            ...
                                                            <img src="assets/media/avatars/07.jpg" alt="..."
                                                        ...
                                                        <p class="small text-body-secondary mb-3">
                                                            <a class="d-block text-reset text-truncate"
                                                                href="#!mailto:noah.pierre@company.com"><span class="__cf_email__" data-cfemail="d0bab1bbbfb2a9fea2bfbdb1be90bdb1b9bcfeb3bfbd">[email&#160;protected]</span></a>
                                                        </p>
                                                        <!-- Split dropdown user button -->
                                                        <div class="btn-group btn-group-sm">
                                                            <button type="button" class="btn btn-outline-secondary"><span class="material-symbols-rounded align-middle me-1 fs-5">
                                                                sms
                                                                </span>Send
                                                                Message</button>
                                                            <button type="button"
                                                                class="btn btn-outline-secondary dropdown-toggle-split rounded-end"
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <li><a class="dropdown-item" href="#"> <span class="material-symbols-rounded align-middle me-1 fs-5">
                                                                    block
                                                                    </span> Block
                                                                        contact</a></li>
                                                            </ul>
                                            ...
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <!-- Title -->
                                                        <h5 class="mb-0">
                                                            <a href="#!" class="text-reset">Marie Jensen</a>
                                                        </h5>

                                                        <!-- Email -->
                                                        <p class="small text-body-secondary mb-3">
                                                            <a class="d-block text-reset text-truncate"
                                                                href="#!mailto:noah.pierre@company.com"><span class="__cf_email__" data-cfemail="9bf6fae9f2feb5f1fef5e8fef5dbf6faf2f7b5f8f4f6">[email&#160;protected]</span></a>
                                                        </p>
                                                        <!-- Split dropdown user button -->
                                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <!-- Title -->
                                                        <h5 class="mb-0">
                                                            <a href="#!" class="text-reset">Glen Rouse</a>
                                                        </h5>

                                                        <!-- Email -->
                                                        <p class="small text-body-secondary mb-3">
                                                            <a class="d-block text-reset text-truncate"
                                                                href="#!mailto:noah.pierre@company.com"><span class="__cf_email__" data-cfemail="1f78737a71316d706a6c7a5f727e7673317c7072">[email&#160;protected]</span></a>
                                                        </p>
                                                        <!-- Split dropdown user button -->
                                                        <div class="btn-group btn-group-sm">
                                                            <button type="button" class="btn btn-outline-secondary"><span class="material-symbols-rounded align-middle me-1 fs-5">
                                        ...
                                        <div class="col-sm-6 col-xl-4">
                                            <!--card-->
                                            <div class="card mb-3 mb-lg-5 mb-xl-0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <!-- Title -->
                                                        <h5 class="mb-0">
                                                            <a href="#!" class="text-reset">Yousif Cross</a>
                                                        </h5>

                                                        <!-- Email -->
                                                        <p class="small text-body-secondary mb-3">
                                                            <a class="d-block text-reset text-truncate"
                                                                href="#!mailto:noah.pierre@company.com"><span class="__cf_email__" data-cfemail="275e4852544e41094455485454674a464e4b0944484a">[email&#160;protected]</span></a>
                                                        </p>
                                                        <!-- Split dropdown user button -->
                                                        <div class="btn-group btn-group-sm">
                                                            <button type="button" class="btn btn-outline-secondary"><span class="material-symbols-rounded align-middle me-1 fs-5">
                                            ...
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <a href="#!"
                                                            class="avatar mb-3 mx-auto xxl rounded-cirlce d-block">
                                                            <img src="assets/media/avatars/06.jpg" alt="..."
                                                                class="img-fluid rounded-circle">
                                                        </a>
                                                        <!-- Title -->
                                                        <h5 class="mb-0">
                                                            <a href="#!" class="text-reset">Edith Koenig</a>
                                                        </h5>

                                                        <!-- Email -->
                                                        <p class="small text-body-secondary mb-3">
                                                            <a class="d-block text-reset text-truncate"
                                                                href="#!mailto:noah.pierre@company.com"><span class="__cf_email__" data-cfemail="187d7c716c703673777d76717f5875797174367b7775">[email&#160;protected]</span></a>
                                                        </p>
                                                        <!-- Split dropdown user button -->
                                                        <div class="btn-group btn-group-sm">
                                                            <button type="button" class="btn btn-outline-secondary"><span class="material-symbols-rounded align-middle me-1 fs-5">
                                            ...
                                            <div class="card mb-3 mb-lg-5">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <a href="#!"
                                                            class="avatar mb-3 mx-auto xxl rounded-cirlce d-block">
                                                            <img src="assets/media/avatars/05.jpg" alt="..."
                                                                class="img-fluid rounded-circle">
                                                        </a>
                                                        <!-- Title -->
                                                        <h5 class="mb-0">
                                                            <a href="#!" class="text-reset">Rachel Leonard</a>
                                                        </h5>

                                                        <!-- Email -->
                                                        <p class="small text-body-secondary mb-3">
                                                            <a class="d-block text-reset text-truncate"
                                                                href="#!mailto:noah.pierre@company.com"><span class="__cf_email__" data-cfemail="dba9bab8b3beb7f5b7beb4b5baa9bf9bb6bab2b7f5b8b4b6">[email&#160;protected]</span></a>
                                                        </p>
                                                        <!-- Split dropdown user button -->
                                                        <div class="btn-group btn-group-sm">
                                                            <button type="button" class="btn btn-outline-secondary"><span class="material-symbols-rounded align-middle me-1 fs-5">
