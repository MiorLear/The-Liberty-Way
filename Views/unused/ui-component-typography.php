                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-components" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link active" href="ui-component-typography.php">Typography</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3 mb-lg-5">
                                    <div class="card">
                                        <div
                                            class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="mb-0">Disaplay headings</h5>
                                        </div>
                                        <div class="card-body">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h3>
                                                ...
                                                <span class="text-body-secondary">With muted text</span>
                                              </h3>
                                              <h3>
                                                Fancy display heading
                                                <span class="text-primary">With primary text</span>
                                              </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 mb-3 mb-lg-5">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p>
                                                This is a default paragraph. It stands out from regular paragraphs.
                                              </p>
                                              <p class="lead">
                                                This is a lead paragraph. It stands out from regular paragraphs.
                                              </p>
                                              <p class="small">
                                                This is a small paragraph. It stands out from regular paragraphs.
                                              </p>
                                              <p class="text-reset">
                                                This is a lead paragraph. It stands out from regular paragraphs.
                                              </p>
                                              <p class="text-body-secondary">
                                                This is a muted paragraph. It stands out from regular paragraphs.
                                              </p>
                                              <p class="text-primary">
                                                This is a primary paragraph. It stands out from regular paragraphs.
                                              </p>
                                              <p class="text-success">
                                                This is a success paragraph. It stands out from regular paragraphs.
                                              </p>
                                              <p class="text-danger">
                                                This is a danger paragraph. It stands out from regular paragraphs.
                                              </p>
                                              <p class="text-warning">
                                                This is a warning paragraph. It stands out from regular paragraphs.
                                              </p>
                                              <p class="text-info mb-0">
                                                This is a info paragraph. It stands out from regular paragraphs.
                                              </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-3 mb-lg-5">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                           <h6 class="text-body-secondary">Unstyled</h6>
                                          ...
                                          <hr>
                                          <h6 class="text-body-secondary">Inline</h6>
                                          ...
                                          <hr>
                                          <h6 class="text-body-secondary">Description list alignment</h6>
                                          <dl class="row mb-0">
