...
<html lang="en">
    ...
    <body>
        ...
        <!--App Start-->
        <div class="d-flex flex-column flex-root bg-cover bg-no-repeat">
            <!--Page-->
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-pages" class="sidebar-dropdown list-unstyled collapse show">
                              <li class="sidebar-item">
                                <a href="#pages-account" data-bs-toggle="collapse" aria-expanded="false" class="sidebar-link active">
                                  Account
                                </a>
                                <ul id="pages-account" class="sidebar-dropdown list-unstyled collapse sd-second-level show">
                                  <li class="sidebar-item">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link pages_tasks" href="page-tasks.php">Tasks</a></li>
                        ...
                        <div class="position-relative container-fluid px-0">
                            <div class="row align-items-center position-relative">
                                <div class="col-md-8 mb-3 mb-lg-0">
                                    ...
                                    <p class="mb-0 text-body-secondary">Update and manage your account</p>
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="content pt-3 px-3 px-lg-6 d-flex flex-column-fluid">
                        <div class="container-fluid px-0">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <!--Account nav-->
                                    <ul class="nav nav-tabs nav-vertical nav-pills mb-3 mb-lg-5 h-100">
                                        <li class="nav-item">
                                            <a href="account-general.php" class="nav-link px-3">
                                                <span class="material-symbols-rounded me-2 align-middle">
                                                    account_circle
                                                </span>General
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="account-billing.php" class="nav-link active px-3">
                                                <span class="material-symbols-rounded me-2 align-middle">
                                                    payments
                                                </span>Billing
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a href="account-contacts.php" class="nav-link px-3">
                                                <span class="material-symbols-rounded me-2 align-middle">
                                                    groups
                                                </span>Contacts
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a href="account-security.php" class="nav-link px-3">
                                                <span class="material-symbols-rounded me-2 align-middle">
                                        ...
                                        <li class="nav-item">
                                            <a href="account-notifications.php" class="nav-link px-3">
                                                <span class="material-symbols-rounded me-2 align-middle">
                                                    notifications_off
                                                </span>Notifications
                                            </a>
                                ...
                                <div class="col-lg-9 h-100">
                                    ...
                                    <div class="card mb-3 mb-lg-5">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-7 mb-4 mb-md-0">
                                                    <h6>Part-time Access</h6>
                                                    <h2 class="mb-1">$19.00</h2>
                                                    <small class="text-body-secondary d-block mb-3">Monthly</small>
                                                    <span
                                                        class="badge badge-pill lh-sm bg-success px-2 py-1">Active</span>
                                                </div>
                                                <div class="col-md-5">
                                                    <h6>Plan Benefits</h6>
                                                    <ul class="mb-0 lh-lg">
                                                        <li>3 transactions per day</li>
                                                        <li>1 Member dashboard</li>
                                                        <li>10GB free data</li>
                                        ...
                                        <div class="card-footer align-items-center d-flex justify-content-between">
                                            <a href="#!" class="me-2 btn btn-primary btn-sm">Upgrade plan</a>
                                            <a href="#!" class="btn btn-secondary btn-sm">Cancel
                                                Subscription</a>
                                        </div>
                                    </div>
                                    <!--/.row-->
                                    ...
                                    <div class="card mb-3 mb-lg-5">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <!--Col-->
                                                <div class="col-12 col-sm-6 order-last mb-3">
                                                    <div
                                                        class="p-3 rounded-3 border shadow-sm d-flex align-items-center position-relative">
                                                        <div>
                                                            <img src="assets/media/brand-logos/visa.svg"
                                                                class="height-20 w-auto me-4" alt="">
                                                        </div>
                                                        <div class="flex-grow-1">
                                                            <span class="d-block">****6231</span>
                                                            <div class="d-flex">
                                                                <small class="text-body-secondary me-2">Expiry date:</small>
                                                                <span class="d-inline-block">09/024</span>
                                                            </div>
                                                        ...
                                                        <div class="h-100 align-self-stretch">
                                                            <div class="dropdown">
                                                                <a href="#"
                                                                    class="d-flex align-items-center justify-content-center size-30 border border-secondary-subtle rounded-circle"
                                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                                    <span
                                                                        class="material-symbols-rounded align-middle fs-5">
                                                                        more_vert
                                                                    </span>
                                                                </a>
                                                                <div class="dropdown-menu mt-1 dropdown-menu-end">
                                                                    <a href="#!" class="dropdown-item">Set primary</a>
                                                                    <a href="#!" class="dropdown-item">Payment
                                                                        history</a>
                                                                    <a href="#!" class="dropdown-item">Remove card</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12 col-sm-6 mb-3 order-1">
                                                    <div
                                                        class="p-3 rounded-3 border shadow-sm d-flex align-items-center position-relative">
                                                        <div>
                                                            <img src="assets/media/brand-logos/mastercard.svg"
                                                                class="height-20 w-auto me-4" alt="">
                                                        </div>
                                                        <div class="flex-grow-1">
                                                            <span class="d-block">****0786</span>
                                                            <div class="d-flex">
                                                                <small class="text-body-secondary me-2">Expiry date:</small>
                                                                <span class="d-inline-block">09/026</span>
                                                            </div>
                                                            <span
                                                                class="badge position-absolute mt-n2 ms-2 start-0 top-100 badge-pill bg-primary">Primary</span>
                                                        </div>
                                                        <div class="h-100 align-self-stretch">
                                                            <div class="dropdown">
                                                                <a href="#"
                                            ...
                                            <div class="text-end">
                                                <a href="#!" class="btn btn-primary btn-sm">
                                                    <span class="material-symbols-rounded me-1 fs-5 align-middle">
                                                        add
                                                    </span> Add New Card</a>
                                            </div>
                                        </div>
                                    ...
                                    <!--card-->
                                    <div class="card mb-3 mb-lg-5 table-card table-nowrap">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped mb-0">
                                                <thead class="text-body-secondary text-uppercase small">
                                                    <tr>
                                                        <th>Invoice ID</th>
                                                        <th>Date</th>
                                                        <th>Amount</th>
                                                ...
                                                <tbody class="fs-base">
                                                    <tr>
                                                        <td>
                                                            <a href="invoice.php">Invoice #56756</a>
                                                        </td>
                                                        <td>
                                                            <time datetime="2020-04-24">Sep. 24, 2021</time>
                                                        </td>
                                                        <td>
                                                            $29.00
                                                        </td>
                                                        <td>
                                                            <span
                                                                class="badge bg-danger-subtle text-danger fw-normal">Pending</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <a href="invoice.php">Invoice #56894</a>
                                                        </td>
                                                        <td>
                                                            <time datetime="2020-03-24">Aug. 04, 2021</time>
                                                        </td>
                                                        <td>
                                                            $29.00
                                                        </td>
                                                        <td>
                                                            <span
                                                                class="badge bg-success-subtle text-success fw-normal">Paid</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <a href="invoice.php">Invoice #57890</a>
                                                        </td>
                                                        <td>
                                                            <time datetime="2020-02-24">Jun. 13, 2021</time>
                                                        </td>
                                                        <td>
                                                            $29.00
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="invoice.php">Invoice #57980</a>
                                                        </td>
                                                        <td>
                                                            <time datetime="2020-01-24">Apr. 03, 2021</time>
                                                        </td>
                                                        <td>
                                                            $29.00
                                                        </td>
                                                        <td>
                                                            <span
                                                                class="badge bg-primary-subtle text-primary fw-normal">Processing...</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
        ...
        <!--Page script begin-->
    <script src="../../Assets/Dashboard/vendor/inputmask.min.js"></script>
        <script>
