                ...
                <ul class="nav flex-column collapse-group collapse d-flex">
                  ...
                  <li class="nav-item">
                    ...
                    <ul id="ui-pages" class="sidebar-dropdown list-unstyled collapse datatabless_collapse">
                      ...
                      <li class="sidebar-item"><a class="sidebar-link datatables_search" href="page-search.php">Search</a></li>
                      <li class="sidebar-item"><a class="sidebar-link datatables_invoice" href="page-invoice.php">Invoice</a></li>
                      <li class="sidebar-item"><a class="sidebar-link datatables_tasks" href="page-tasks.php">Tasks</a></li>
                      <li class="sidebar-item"><a class="sidebar-link datatables_pricing" href="page-pricing.php">Pricing</a></li>
                      <li class="sidebar-item">
                      ...
                      <li class="sidebar-item"><a class="sidebar-link datatables_404" href="page-404.php">404 Error</a></li>
                      <li class="sidebar-item"><a class="sidebar-link datatables_blank" href="page-blank.php">Blank Page</a></li>
                    </ul>
                  </li>
