...
<html lang="en">
    ...
    <head>
        ...
        <!--Map style-->
        <link rel="stylesheet" href="../../Assets/Dashboard/vendor/css/jsvectormap.min.css">
        <!--Main style-->
                      ...
                      <nav class="flex-grow-1 h-100" id="page-navbar">
                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-pages" class="sidebar-dropdown list-unstyled collapse mapss_collapse">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link maps_search" href="page-search.php">Search</a></li>
                              <li class="sidebar-item"><a class="sidebar-link maps_invoice" href="page-invoice.php">Invoice</a></li>
                              <li class="sidebar-item"><a class="sidebar-link maps_tasks" href="page-tasks.php">Tasks</a></li>
                              <li class="sidebar-item"><a class="sidebar-link maps_pricing" href="page-pricing.php">Pricing</a></li>
                              <li class="sidebar-item">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link maps_404" href="page-404.php">404 Error</a></li>
                              <li class="sidebar-item"><a class="sidebar-link maps_blank" href="page-blank.php">Blank Page</a></li>
                            </ul>
                          </li>
