                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-components" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link active" href="ui-component-offcanvas.php">Offcanvas</a></li>
                        ...
                        <div class="container-fluid  px-0">
                            <div class="row">
                                <div class="col-12 col-md-6 mb-3 mb-lg-5">
                                    <div class="card overflow-hidden">
                                        <div class="card-header">
                                            <h5 class="mb-0">Basic Offcanvas</h5>
                                        </div>
                                        <div class="card-body">
                                            <!--offcanvas example-->
                                ...
                                <div class="col-12 col-md-6 mb-3 mb-lg-5">
                                    <div class="card overflow-hidden">
                                        <div class="card-header">
                                            <h5 class="mb-0">Body scrolling Offcanvas</h5>
                                        </div>
                                        <div class="card-body">
                                ...
                                <div class="col-12 col-md-6 mb-3 mb-lg-5">
                                    <div class="card overflow-hidden">
                                        <div class="card-header">
                                            <h5 class="mb-0">Body scrolling with backdrop</h5>
                                        </div>
                                        <div class="card-body">
                                ...
                                <div class="col-12 col-md-6 mb-3 mb-lg-5">
                                    <div class="card overflow-hidden">
                                        <div class="card-header">
                                            <h5 class="mb-0">Static offcanvas</h5>
                                        </div>
                                        <div class="card-body">
