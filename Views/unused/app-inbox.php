...
<html lang="en">
    ...
    <body class="app-chat">
        ...
        <!--App Start-->
        <div class="d-flex flex-column flex-root bg-body">
            <!--Page-->
                      ...
                      <nav class="flex-grow-1 h-100" id="page-navbar">
                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-pages" class="sidebar-dropdown list-unstyled collapse inboxs_collapse">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link inbox_search" href="page-search.php">Search</a></li>
                              <li class="sidebar-item"><a class="sidebar-link inbox_invoice" href="page-invoice.php">Invoice</a></li>
                              <li class="sidebar-item"><a class="sidebar-link inbox_tasks" href="page-tasks.php">Tasks</a></li>
                              <li class="sidebar-item"><a class="sidebar-link inbox_pricing" href="page-pricing.php">Pricing</a></li>
                              <li class="sidebar-item">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link inbox_404" href="page-404.php">404 Error</a></li>
                              <li class="sidebar-item"><a class="sidebar-link inbox_blank" href="page-blank.php">Blank Page</a></li>
                            </ul>
                          </li>
                    ...
                    <div class="px-3 px-lg-6">
                        <div class="content content-wrapper content-expand-md">
                            ...
                            <div class="content-left">
                                <div class="content-sidebar card align-items-stretch h-100"
                                    id="content-sidebar">
                                    <!--content-sidebar-header-->
                                    <div class="content-sidebar-header d-flex p-4 align-items-center position-relative">

                                        <a href="#modal_compose" data-bs-toggle="modal"
                                            class="btn me-5 me-md-0 btn-outline-secondary d-flex flex-grow-1 justify-content-center align-items-center">
                                            <span class="material-symbols-rounded align-middle me-2">
                                                edit
                                                </span>
                                            <span class="">Compose</span></a>
                                        <button type="button"
                                    ...
                                    <div class="content-sidebar-body card-body">
                                        <div class="nav nav-pills nav-vertical mb-5 flex-column">
                                            <a href="app-inbox.php" class="nav-link mb-1 active">
                                                <span class="material-symbols-rounded align-middle me-2">
                                                    inbox
                                                    </span>
                                                Inbox
                                        ...
                                        <span class="small text-body-secondary d-block mb-4">Labels</span>
                                        <div class="nav nav-pills nav-vertical flex-column">
                                            <a href="#!" class="nav-link d-flex align-items-center">
                                               <span class="size-10 me-3 rounded-circle bg-success"></span>
                                               Work
                                            </a>
                                            <a href="#!" class="nav-link d-flex align-items-center">
                                                <span class="size-10 me-3 rounded-circle bg-danger"></span>
                                                Friends
                                             </a>
                                             <a href="#!" class="nav-link d-flex align-items-center ">
                                                <span class="size-10 me-3 rounded-circle bg-info"></span>
                                                Family
                                             </a>
                                             <a href="#!" class="nav-link d-flex align-items-center">
                                                <span class="size-10 me-3 rounded-circle bg-warning"></span>
                                                Others
                                             </a>
                                            </div>
                                    </div>
                            ...
                            <!--content-right-->
                            <div id="mailList" class="content-right card align-items-stretch h-100">

                                <!--content right Header-->
                                <div class="content-right-header rounded-0 card-header px-4">
                                    <div class="d-flex w-100 align-items-center">
                                        <div class="d-flex align-items-center pe-2 pe-lg-5">
                                            <!--check-->
                                            ...
                                            <div class="d-sm-flex d-none align-items-center">
                                                <small class="flex-shrink-0 me-1 me-md-2 text-body-secondary d-none d-md-block">2
                                                    Selected</small>
                                                <div class="me-1 me-md-0 ms-md-2 btn-group btn-group-sm" role="group">
                                        ...
                                        <div class="d-flex flex-grow-1 align-items-center">
                                            <form action="" class="position-relative flex-grow-1 me-1 me-lg-2">
                                                <!--Icon-->
                                                ...
                                                <input type="text" class="form-control search ps-6 py-1"
                                                    placeholder="Search email by label, name...">
                                            </form>
                                            <div class="dropdown">
                                                <a href="#" class="btn btn-sm btn-outline-secondary px-1" data-bs-toggle="dropdown">
                                                    <span class="material-symbols-rounded align-middle fs-5">
                                                        more_horiz
                                                        </span>
                                                </a>
                                        ...
                                        <div class="ms-2 d-md-none">
                                            <button type="button"
                                                class="content_sidebar_toggler btn btn-sm btn-primary px-1">
                                                <span class="material-symbols-rounded align-middle fs-5">
                                                   menu_open
                                                    </span>
                                            </button>
                                ...
                                <!--content-right body-->
                                <div class="content-right-body card-body flex-column p-0">
                                    <div class="flex-row-fluid">
                                        ...
                                        <ul class="list-group list-group-flush list">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--check-->
                                                    <div class="form-check shrink-0 mb-0 me-1 position-relative z-2">
                                                        <input type="checkbox" class="form-check-input" id="check_inbox_1">
                                                        <label for="check_inbox_1" class="form-check-label"></label>
                                                    </div>
                                                    <div
                                                        class="form-star shrink-0 mb-0 me-2 d-md-flex d-none position-relative z-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden pe-4">
                                                            ...
                                                            <div class="d-flex align-items-center mb-0">
                                                                <div class="mb-0 me-2 fw-bold flex-shrink-0 name">Helena Markita
                                                                </div>
                                                                <span
                                                                    class="badge label bg-danger flex-shrink-0 rounded-pill ms-auto">Friends</span>
                                                            </div>
                                                            <p class="small fw-bold mb-0"></p>
                                                            <p class="lh-sm text-truncate mb-0">

                                                                <span class="fw-bold me-2 me-lg-4">New Event
                                                                    Created</span>
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <div class="d-flex align-items-center mb-2">
                                                                    <span class="material-symbols-rounded align-middle fs-6 me-2">
                                                                        attachment
                                                                        </span>
                                                                    <span
                                                                        class="size-10 bg-primary rounded-circle d-inline-block mb-2"></span>
                                                                </div>
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">Just Now</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--Link-->
                                                <a href="app-inbox-detail.php" class="stretched-link"></a>
                                            </li>
                                            <!--Inbox-item-->
                                            <li
                                                class="list-group-item list-group-item-action px-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden pe-4">
                                                            <!--name class for search results-->
                                                            <div class="d-flex align-items-center mb-0">
                                                                <div class="mb-0 me-2 flex-shrink-0 name fw-semibold">Jason
                                                                    Greenwood</div>
                                                                <span
                                                                    class="badge label bg-success flex-shrink-0 rounded-pill ms-auto">Work</span>
                                                            </div>
                                                            <p class="small fw-bold mb-0"></p>
                                                            <p class="lh-sm text-truncate mb-0">

                                                                <span class="fw-normal me-2 me-lg-4">Replace images for
                                                                    Project Gama</span>
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                sed do eiusmod tempor incididunt ut labore et dolore
                                                                magna aliqua.
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">2d</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-check shrink-0 mb-0 me-1 position-relative z-2">
                                                        ...
                                                        <label for="check_3" class="form-check-label"></label>
                                                    </div>
                                                    <div
                                                        class="form-star shrink-0 mb-0 me-2 d-md-flex d-none position-relative z-2">
                                                        <input type="checkbox" class="form-star-input" id="starred_3">
                                                        <label for="starred_3" class="form-star-label"></label>
                                                    </div>
                                                    <div
                                                        class="shrink-0 d-flex flex-grow-1 ms-1 overflow-hidden align-items-center justify-content-start">
                                                        <div
                                                            class="size-35 me-2 me-lg-3 d-flex align-items-center p-1 justify-content-center rounded-circle flex-shrink-0 overflow-hidden">
                                                            <img src="assets/media/brand-logos/bootstrap.svg"
                                                                class="w-100 flex-shrink-0 h-auto" alt="">
                                                        </div>
                                                        <div class="flex-grow-1 overflow-hidden pe-4">
                                                            <!--name class for search results-->
                                                            <div class="d-flex align-items-center mb-0">
                                                                <div class="mb-0 me-2 flex-shrink-0 name fw-semibold">Bootstrap
                                                                </div>
                                                                <span
                                                                    class="badge label bg-warning flex-shrink-0 rounded-pill ms-auto">Others</span>
                                                            </div>
                                                            <p class="small fw-bold mb-0"></p>
                                                            <p class="lh-sm text-truncate mb-0">

                                                                <span class="fw-normal me-2 me-lg-4">New update v5.1.3
                                                                    Avaialable</span>
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                sed do eiusmod tempor incididunt ut labore et dolore
                                                                magna aliqua.
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                <!--New indicator-->
                                                                <div class="d-flex align-items-center mb-2">
                                                                    <!--  <span class="material-symbols-rounded align-middle fs-5 me-3">
                                                                        attach_file
                                                                        </span>
                                                        <span class="size-10 bg-primary rounded-circle d-inline-block mb-2"></span> -->
                                                                </div>
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">22 Feb.</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden pe-4">
                                                            <!--name class for search results-->
                                                            <div class="d-flex align-items-center mb-0">
                                                                <div class="mb-0 me-2 flex-shrink-0 name fw-semibold">Mark oto</div>
                                                                <span
                                                                    class="badge label bg-info flex-shrink-0 rounded-pill ms-auto">Family</span>
                                                            </div>
                                                            <p class="small fw-bold mb-0"></p>
                                                            <p class="lh-sm text-truncate mb-0">

                                                                <span class="fw-normal me-2 me-lg-4">Shared tour images
                                                                    to family group</span>
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                sed do eiusmod tempor incididunt ut labore et dolore
                                                                magna aliqua.
                                                            </p>
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">16 Feb.</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-check shrink-0 mb-0 me-1 position-relative z-2">
                                                        ...
                                                        <label for="check_5" class="form-check-label"></label>
                                                    </div>
                                                    <div
                                                        class="form-star shrink-0 mb-0 me-2 d-md-flex d-none position-relative z-2">
                                                        <input type="checkbox" class="form-star-input" id="starred_5">
                                                        <label for="starred_5" class="form-star-label"></label>
                                                    </div>
                                                    <div
                                                        class="shrink-0 d-flex flex-grow-1 ms-1 overflow-hidden align-items-center justify-content-start">
                                                        <div
                                                            class="size-35 me-2 me-lg-3 d-flex align-items-center p-1 justify-content-center rounded-circle flex-shrink-0 overflow-hidden">
                                                            <img src="assets/media/brand-logos/dropbox.svg"
                                                                class="img-fluid" alt="">
                                                        </div>
                                                        <div class="flex-grow-1 overflow-hidden pe-4">
                                                            <!--name class for search results-->
                                                            <div class="d-flex align-items-center mb-0">
                                                                <div class="mb-0 me-2 flex-shrink-0 name fw-semibold">Dropbox</div>
                                                                <span
                                                                    class="badge label bg-warning flex-shrink-0 rounded-pill ms-auto">others</span>
                                                            </div>
                                                            <p class="small fw-bold mb-0"></p>
                                                            <p class="lh-sm text-truncate mb-0">
                                                                ...
                                                                <span class="fw-normal me-2 me-lg-4">Subscription</span>
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                sed do eiusmod tempor incididunt ut labore et dolore
                                                                magna aliqua.
                                                            </p>
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">20 Jan</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div
                                                        class="form-star shrink-0 mb-0 me-2 d-md-flex d-none position-relative z-2">
                                                        <input type="checkbox" class="form-star-input" checked
                                                            id="starred_6">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden pe-4">
                                                            <!--name class for search results-->
                                                            <div class="d-flex align-items-center mb-0">
                                                                <div class="mb-0 me-2 flex-shrink-0 name fw-semibold">Tahila Mooney
                                                                </div>
                                                                <span
                                                                    class="badge label bg-danger flex-shrink-0 rounded-pill ms-auto">Friends</span>
                                                            </div>
                                                            ...
                                                            <p class="lh-sm text-truncate mb-0">
                                                                ...
                                                                <span class="fw-normal me-2 me-lg-4">Invitation for
                                                                    weekend party</span>
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                sed do eiusmod tempor incididunt ut labore et dolore
                                                                magna aliqua.
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">31 Dec 21</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-check shrink-0 mb-0 me-1 position-relative z-2">
                                                        ...
                                                        <label for="check_7" class="form-check-label"></label>
                                                    </div>
                                                    <div
                                                        class="form-star shrink-0 mb-0 me-2 d-md-flex d-none position-relative z-2">
                                                        <input type="checkbox" class="form-star-input" checked
                                                            id="starred_7">
                                                        <label for="starred_7" class="form-star-label"></label>
                                                    </div>
                                                    <div
                                                        class="shrink-0 d-flex flex-grow-1 ms-1 overflow-hidden align-items-center justify-content-start">
                                                        <div
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden pe-4">
                                                            <!--name class for search results-->
                                                            <div class="d-flex align-items-center mb-0">
                                                                <div class="mb-0 me-2 flex-shrink-0 name fw-semibold">Diana
                                                                    Hazelwood</div>
                                                                <span
                                                                    class="badge label bg-success flex-shrink-0 rounded-pill ms-auto">Work</span>
                                                            </div>
                                                            ...
                                                            <p class="lh-sm text-truncate mb-0">
                                                                ...
                                                                <span class="fw-normal me-2 me-lg-4">New Task
                                                                    Assigned</span>
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                sed do eiusmod tempor incididunt ut labore et dolore
                                                                magna aliqua.
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">24 Dec 21</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-check shrink-0 mb-0 me-1 position-relative z-2">
                                                        ...
                                                        <label for="check_8" class="form-check-label"></label>
                                                    </div>
                                                    <div
                                                        class="form-star shrink-0 mb-0 me-2 d-md-flex d-none position-relative z-2">
                                                        <input type="checkbox" class="form-star-input" id="starred_8">
                                                        <label for="starred_8" class="form-star-label"></label>
                                                    </div>
                                                    <div
                                                        class="shrink-0 d-flex flex-grow-1 ms-1 overflow-hidden align-items-center justify-content-start">
                                                        <div
                                                            class="size-35 me-2 me-lg-3 d-flex align-items-center p-1 justify-content-center rounded-circle flex-shrink-0 overflow-hidden">
                                                            <img src="assets/media/brand-logos/dribbble.svg"
                                                                class="w-100 h-auto" alt="">
                                                        </div>
                                                        <div class="flex-grow-1 overflow-hidden pe-4">
                                                            <!--name class for search results-->
                                                            <div class="d-flex align-items-center mb-0">
                                                                <div class="mb-0 me-2 flex-shrink-0 name fw-semibold">Dribbble</div>
                                                                <span
                                                                    class="badge label bg-warning flex-shrink-0 rounded-pill ms-auto">Others</span>
                                                            </div>
                                                            <p class="small fw-bold mb-0"></p>
                                                            <p class="lh-sm text-truncate mb-0">
                                                                ...
                                                                <span class="fw-normal me-2 me-lg-4">Adriana liked your
                                                                    shot</span>
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                sed do eiusmod tempor incididunt ut labore et dolore
                                                                magna aliqua.
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">02 Dec 21</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-check shrink-0 mb-0 me-1 position-relative z-2">
                                                        ...
                                                        <label for="check_9" class="form-check-label"></label>
                                                    </div>
                                                    <div
                                                        class="form-star shrink-0 mb-0 me-2 d-md-flex d-none position-relative z-2">
                                                        <input type="checkbox" class="form-star-input" id="starred_9">
                                                        <label for="starred_9" class="form-star-label"></label>
                                                    </div>
                                                    <div
                                                        class="shrink-0 d-flex flex-grow-1 ms-1 overflow-hidden align-items-center justify-content-start">
                                                        <div
                                                            class="size-35 me-2 me-lg-3 d-flex align-items-center justify-content-center rounded-circle flex-shrink-0 overflow-hidden">
                                                            <img src="assets/media/brand-logos/paypal.svg"
                                                                class="w-100 h-auto" alt="">
                                                        </div>
                                                        <div class="flex-grow-1 overflow-hidden pe-4">
                                                            <!--name class for search results-->
                                                            <div class="d-flex align-items-center mb-0">
                                                                <div class="mb-0 me-2 flex-shrink-0 name fw-semibold">Paypal</div>
                                                                <span
                                                                    class="badge label bg-warning flex-shrink-0 rounded-pill ms-auto">Others</span>
                                                            </div>
                                                            <p class="small fw-bold mb-0"></p>
                                                            <p class="lh-sm text-truncate mb-0">
                                                                ...
                                                                <span class="fw-normal me-2 me-lg-4">Action
                                                                    required</span>
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                sed do eiusmod tempor incididunt ut labore et dolore
                                                                magna aliqua.
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">21 Nov 21</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-check shrink-0 mb-0 me-1 position-relative z-2">
                                                        ...
                                                        <label for="check_10" class="form-check-label"></label>
                                                    </div>
                                                    <div
                                                        class="form-star shrink-0 mb-0 me-2 d-md-flex d-none position-relative z-2">
                                                        <input type="checkbox" class="form-star-input" id="starred_10">
                                                        <label for="starred_10" class="form-star-label"></label>
                                                    </div>
                                                    <div
                                                        class="shrink-0 d-flex flex-grow-1 ms-1 overflow-hidden align-items-center justify-content-start">
                                                        <div
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden pe-4">
                                                            <!--name class for search results-->
                                                            <div class="d-flex align-items-center mb-0">
                                                                <div class="mb-0 me-2 flex-shrink-0 name fw-semibold">Dusan Vlahovic
                                                                </div>
                                                                <span
                                                                    class="badge label bg-success flex-shrink-0 rounded-pill ms-auto">Work</span>
                                                            </div>
                                                            ...
                                                            <p class="lh-sm text-truncate mb-0">
                                                                ...
                                                                <span class="fw-normal me-2 me-lg-4">Request for Payment
                                                                    Approval</span>
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                                sed do eiusmod tempor incididunt ut labore et dolore
                                                                magna aliqua.
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">13 Nov 21</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--check-->
                                                    <div class="form-check shrink-0 mb-0 me-1 position-relative z-2">
                                                        <input type="checkbox" class="form-check-input" id="check_11">
                                                        <label for="check_11" class="form-check-label"></label>
                                                    </div>
                                                    <div
                                                        class="form-star shrink-0 mb-0 me-2 d-md-flex d-none position-relative z-2">
                                                        <input type="checkbox" class="form-star-input" id="starred_11">
                                                        <label for="starred_11" class="form-star-label"></label>
                                                    </div>
                                                    <div
                                                        class="shrink-0 d-flex flex-grow-1 ms-1 overflow-hidden align-items-center justify-content-start">
                                                        <div
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">28 Oct 21</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--check-->
                                                    <div class="form-check shrink-0 mb-0 me-1 position-relative z-2">
                                                        <input type="checkbox" class="form-check-input" id="check_12">
                                                        <label for="check_12" class="form-check-label"></label>
                                                    </div>
                                                    <div
                                                        class="form-star shrink-0 mb-0 me-2 d-md-flex d-none position-relative z-2">
                                                        <input type="checkbox" class="form-star-input" id="starred_12">
                                                        <label for="starred_12" class="form-star-label"></label>
                                                    </div>
                                                    <div
                                                        class="shrink-0 d-flex flex-grow-1 ms-1 overflow-hidden align-items-center justify-content-start">
                                                        <div
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--Time-->
                                                                <span class="block small text-body-secondary">17 Oct 21</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="btn-group btn-group-sm ms-3">
                                                <button disabled class="btn btn-outline-secondary px-1" type="button">
                                                    <span class="material-symbols-rounded fs-5 align-middle">
                                                        arrow_back
                                                        </span>
                                                </button>
                                                <button class="btn btn-outline-secondary px-1" type="button">
                                                    <span class="material-symbols-rounded fs-5 align-middle">
                                                        arrow_forward
                                                        </span>
                                                </button>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div
                        ...
                        <button class="btn text-white shadow-none small" data-bs-dismiss="modal"
                    ...
                    <div class="p-4 modal-body">
                        <form>
                            ...
                            <!--Quill editor-->
                            <div class="mb-3" data-quill='{"placeholder": "Enter your message here..."}'>

                            </div>
                            <div class="d-flex justify-content-end pt-4">
                                <button type="button" class="btn btn-outline-secondary btn-sm">Save to Draft</button>
                                <button type="button" class="btn btn-outline-primary btn-sm ms-2">Send message</button>
                            </div>
                        </form>
                    </div>
                </div>
