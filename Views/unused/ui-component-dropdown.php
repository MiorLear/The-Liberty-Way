                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-components" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link active" href="ui-component-dropdown.php">Dropdowns</a> </li>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 col-lg-4 mb-3 mb-lg-5">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!--Dropdown menu-->
                                            <div class="dropdown">
                                                <a href="#" class="btn btn-light" data-bs-toggle="dropdown">Open
                                                    Dropdown</a>
                                                <div class="dropdown-menu">
                                                    <a href="#!" c"lass="dropdown-item>Dropdown item</a>
                                                    <a href="#!" class="dropdown-item">Another item</a>
                                                    <a href="#!" class="dropdown-item">Some other item</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="dropdown">
                                                <a href="#" class="btn btn-light dropdown-toggle"
                                                    data-bs-toggle="dropdown">Open Dropdown</a>
                                                <div class="dropdown-menu">
                                ...
                                <div class="col-12 col-sm-6 col-lg-4 mb-3 mb-lg-5">
                                    <div class="card">
                                        <div
                                            class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="mb-0">Auto close outside</h5>
                                        </div>
                                        <div class="card-body">

                                            <!--Dropdown menu-->
                                            <div class="dropdown">
                                                <a href="#" class="btn btn-light dropdown-toggle" data-bs-auto-close="outside"
                                                    data-bs-toggle="dropdown">Open Dropdown</a>
                                                <div class="dropdown-menu">
                                                    <a href="#!" class="dropdown-item">Dropdown item</a>
                                                    <a href="#!" class="dropdown-item">Another item</a>
                                ...
                                <div class="col-12 col-sm-6 col-lg-4 mb-3 mb-lg-5">
                                    <div class="card">
                                        <div
                                            class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="mb-0">Auto close false</h5>
                                        </div>
                                        <div class="card-body">

                                            <!--Dropdown menu-->
                                            <div class="dropdown">
                                                <a href="#" class="btn btn-light dropdown-toggle" data-bs-auto-close="false"
                                                    data-bs-toggle="dropdown">Open Dropdown</a>
                                                <div class="dropdown-menu">
                                                    <a href="#!" class="dropdown-item">Dropdown item</a>
                                                    <a href="#!" class="dropdown-item">Another item</a>
                                ...
                                <div class="col-12 col-sm-6 col-lg-4 mb-3 mb-lg-5">
                                    <div class="card">
                                        <div
                                            class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="mb-0">Direction end</h5>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="dropend">
                                                <a href="#" class="btn btn-light dropdown-toggle"
                                                    data-bs-toggle="dropdown">Open Dropend</a>
                                                <div class="dropdown-menu">
                                                    <a href="#!" class="dropdown-item">Dropdown item</a>
                                                    <a href="#!" class="dropdown-item">Another item</a>
                                                    <a href="#!" class="dropdown-item">Some other item</a>
                                ...
                                <div class="col-12 col-sm-6 col-lg-4 mb-3 mb-lg-5">
                                    <div class="card">
                                        <div
                                            class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="mb-0">Direction start</h5>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="dropstart">
                                                <a href="#" class="btn btn-light dropdown-toggle"
                                                    data-bs-toggle="dropdown">Open DropStart</a>
                                                <div class="dropdown-menu">
                                                    <a href="#!" class="dropdown-item">Dropdown item</a>
                                                    <a href="#!" class="dropdown-item">Another item</a>
                                                    <a href="#!" class="dropdown-item">Some other item</a>
                                ...
                                <div class="col-12 col-sm-6 col-lg-4 mb-3 mb-lg-5">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="dropup">
                                                <a href="#" class="btn btn-light dropdown-toggle"
                                                    data-bs-toggle="dropdown">Open Dropup</a>
                                                <div class="dropdown-menu">
                                                    <a href="#!" class="dropdown-item">Dropdown item</a>
                                                    <a href="#!" class="dropdown-item">Another item</a>
                                                    <a href="#!" class="dropdown-item">Some other item</a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="dropdown">
                                                <a href="#" class="btn btn-light dropdown-toggle"
                                                    data-bs-toggle="dropdown">Open Dropdown</a>
                                                <div class="dropdown-menu">
                                                    <a href="#!" class="dropdown-item"><span class="material-symbols-rounded align-middle me-1">send</span> Dropdown item</a>
                                                    <a href="#!" class="dropdown-item"> <span class="material-symbols-rounded align-middle me-1">save</span> Another item</a>
                                                    <a href="#!" class="dropdown-item"><span class="material-symbols-rounded align-middle me-1">delete</span> Some other item</a>
                                                </div>
                                            </div>
                                            <hr>
                                            <!--Dropdown menu-->
                                            <div class="dropup">
                                                <a href="#" class="btn btn-light px-2"
                                                    ...
                                                    <span class="align-middle material-symbols-rounded">more_vert</span>
                                                </a>
                                                <div class="dropdown-menu" style="min-width: auto; width:auto">
                                                    <a href="#!" class="dropdown-item"><span class="material-symbols-rounded align-middle">send</span> </a>
                                                    <a href="#!" class="dropdown-item"> <span class="material-symbols-rounded align-middle">save</span> </a>
                                                    <a href="#!" class="dropdown-item"><span class="material-symbols-rounded align-middle">delete</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-sm-6 col-lg-4 mb-3 mb-lg-5">
                                    <div class="card">
                                        <div
                                            class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="mb-0">Multi level</h5>
                                        </div>
                                        <div class="card-body">

                                            <!--Dropdown menu-->
                                            <div class="dropdown">
                                                <a href="#" data-bs-auto-close="outside" class="btn btn-light dropdown-toggle"
                                                    data-bs-toggle="dropdown">Open Dropdown</a>
                                                <div class="dropdown-menu">
                                                    <a href="#!" class="dropdown-item"> Dropdown item</a>
                                                    <div class="dropend">
                                                        <a href="#" class="dropdown-item dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown"> 
                                                            Another level
                                                        </a>
                                                        <div class="dropdown-menu">
                                                            <a href="#!" class="dropdown-item">Another item</a>
