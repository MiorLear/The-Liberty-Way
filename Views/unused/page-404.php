                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-pages" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link active" href="page-404.php">404 Error</a></li>
                                      ...
                                      <div class="card-body p-md-5 p-lg-7">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-6">The page your are trying to reach is not found!</p>
                                                <a href="index.php" class="btn btn-light btn-sm">Go back to Dashboard</a>
                                            </div>
                                        </div>
                                      </div>
                                  </div>
