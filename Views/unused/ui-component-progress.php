                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-components" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link active" href="ui-component-progress.php">Progress</a></li>
                    ...
                    <div class="toolbar px-3 px-lg-6 py-3">
                        <div class="position-relative container-fluid px-0">
                            <div class="row align-items-center position-relative">
                                <div class="col-md-8">
                                    <h3 class="mb-2">Progress Bars</h3>
                        ...
                        <div class="container-fluid px-0">
                            <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="progress mb-3">
                                              ...
                                              <div class="progress bg-success-subtle mb-3">
                                              ...
                                              <div class="progress bg-danger-subtle mb-3">
                                              ...
                                              <div class="progress bg-warning-subtle mb-3">
                                ...
                                <div class="col-12 mb-3 mb-lg-5">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="mb-0">Custom Height and Labels</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="progress mb-3" style="height: 4px;">
                                              ...
                                              <div>
                                                  ...
                                                  <div class="progress mb-3" style="height: 14px;">
                                                    <div class="progress-bar progress-bar-striped progress-bar-animated p-1" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 75%">75%</div>
                                                  </div>
                                              </div>
                                        </div>
                                    </div>
