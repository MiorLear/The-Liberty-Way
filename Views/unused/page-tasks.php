...
<html lang="en">
    ...
    <head>
        ...
        <!--Page style-->
        <link rel="stylesheet" href="../../Assets/Dashboard/vendor/css/dragula.min.css">
                        ...
                        <ul class="nav flex-column collapse-group collapse d-flex">
                          ...
                          <li class="nav-item">
                            ...
                            <ul id="ui-pages" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link pages_search" href="page-search.php">Search</a></li>
                              <li class="sidebar-item"><a class="sidebar-link pages_invoice" href="page-invoice.php">Invoice</a></li>
                              <li class="sidebar-item"><a class="sidebar-link active" href="page-tasks.php">Tasks</a></li>
                              <li class="sidebar-item"><a class="sidebar-link pages_pricing" href="page-pricing.php">Pricing</a></li>
                              <li class="sidebar-item">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link pages_404" href="page-404.php">404 Error</a></li>
                              <li class="sidebar-item"><a class="sidebar-link pages_blank" href="page-blank.php">Blank Page</a></li>
                            </ul>
                          </li>
                        ...
                        <div class="position-relative container-fluid px-0">
                            <div class="row align-items-center position-relative">
                                ...
                                <div class="col-md-5 text-md-end">
                                    <div class="dropdown">
                                        <a href="#" data-bs-auto-close="outside" class="btn btn-primary d-inline-flex align-items-center dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                            <small>CRM dashboard</small>
                                         </a>
                                         <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-sm mt-2">
                                            <form>
                                                <div class="d-flex align-items-center p-1 border-bottom ps-4">
                                                    <div class="text-body-secondary">
                                                        <span class="align-middle opacity-50 material-symbols-rounded">search</span>
                                                    </div>
                                                    <input type="text" autofocus="" class="form-control bg-transparent rounded-0 py-3 ps-2 border-0 shadow-none" placeholder="Search Projects...">
                                                </div>
                                            </form>
                                            <div class="py-3">
                                             <div class="px-3 py-1">
                                                <div class="form-check mb-0">
                                                    <input type="radio" name="projects" id="p1" checked class="form-check-input">
                                                    <label for="p1" class="form-check-label">CRM dashboard</label>
                                                </div>
                                             </div>
                                             <div class="py-1 px-3">
                                                <div class="form-check mb-0">
                                                    <input type="radio" name="projects" id="p2" class="form-check-input">
                                                    <label for="p2" class="form-check-label">Music web app</label>
                                                </div>
                                             </div>
                                             <div class="py-1 px-3">
                                                <div class="form-check mb-0">
                                                    <input type="radio" name="projects" id="p3" class="form-check-input">
                                                    <label for="p3" class="form-check-label">Nike mobile app</label>
                                                </div>
                                             </div>
                                             <div class="py-1 px-3">
                                                <div class="form-check mb-0">
                                                    <input type="radio" name="projects" id="p4" class="form-check-input">
                                                    <label for="p4" class="form-check-label">Higuen branding</label>
                                                </div>
                                             </div>
                                             <div class="py-1 px-3">
                                                <div class="form-check mb-0">
                                                    <input type="radio" name="projects" id="p5" class="form-check-input">
                                                    <label for="p5" class="form-check-label">Job board management</label>
                                                </div>
                                             </div>
                                            </div>
                                             <!-- <a href="#!.php" class="dropdown-item active"> #CRM Dashboard</a>
                                             <a href="#!.php" class="dropdown-item">#Music web app</a>
                                             <a href="#!.php" class="dropdown-item">#Nike mobile app</a>
                                             <a href="#!.php" class="dropdown-item">#Higuen branding</a>
                                             <a href="#!.php" class="dropdown-item">#Job board management</a> -->
                                             <div class="dropdown-divider mt-0"></div>
                                             <div class="text-end p-3">
                                                <a href="#!" class="btn btn-sm btn-secondary">View all Projects</a>
                                             </div>
                                         </div>
                                    </div>
                                </div>
                    ...
                    <div class="content d-flex flex-column-fluid py-3 px-3 px-lg-6">
                       ...
                       <div class="container-fluid px-0">
                        ...
                        <div class="board row mb-3 mb-lg-5">
                            <!--Kanban task column-->
                            <div class="tasks mb-7 mb-md-0 col-md-4" data-dragula="tasks"
                                data-containers='["tasks-initials", "tasks-inprogress", "tasks-done"]'>
                                <div>
                                    <h6 class="mb-4 text-body-secondary">Initial (4)</h6>
                                </div>

                                <!--Task initials-->
                                <div id="tasks-initials" class="task-list-items">

                                    <!-- Task card begins-->
                                    <div
                                        class="card card-body shadow-none bg-danger-subtle border-0 mt-3 mt-lg-5 hover-lift transition-base">
...
today
                                                ...
                                                <!--Task Heading-->
                                                <h6 class="mb-4 fs-5 fw-medium"><a href="#!.php" class="text-reset">Voluptate commodo exercitation culpa non incididunt laboris sint aliquip est</a></h6>
                                                ...
                                                <div>
                                                    <div class="avatar-group justify-content-end">
                                                        <a href="#!.php"
                                                            ...
                                                            <img src="assets/media/avatars/04.jpg" alt="..."
                                                        ...
                                                        <a href="#!.php"
                                                            ...
                                                            <img src="assets/media/avatars/02.jpg" alt="..."
                                                                class="avatar-group-img rounded-circle">
                                                        </a>
                                                        <a href="#!.php"
                                                            class="avatar-group-item avatar xs rounded-circle"
                                                            ...
                                                            <img src="assets/media/avatars/03.jpg" alt="..."
                                                                class="avatar-group-img rounded-circle">
                                                        </a>
                                                        <a href="#!.php"
                                                            ...
                                                            data-tippy-placement="top"
                                                            data-tippy-content="3 more members">
                                                            <b class="small">+3</b>
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <!--Task checkbox-->
                                            <span class="form-check me-0 pe-0 mb-0">
                                                <input type="checkbox" class="form-check-input form-check-input-danger mx-0">
                                            </span>
                                        </div>
                                    </div>
                                    <!--/. Task card ends-->
                                    ...
                                    <!-- Task card begins-->
                                    <div
                                        class="card card-body shadow-none bg-info-subtle border-0 mt-3 mt-lg-5 hover-lift transition-base">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div>
                                                <!--Task date-->
                                                <span class="d-flex align-items-center mb-2 small text-body-secondary"><span class="align-middle me-2 material-symbols-rounded fs-5">
today
                                                ...
                                                <!--Task Heading-->
                                                <h6 class="mb-4 fs-5 fw-medium"><a href="#!.php" class="text-reset">Occaecat consectetur deserunt nisi aliqua aute</a></h6>
                                            ...
                                            <!--Task checkbox-->
                                            <span class="form-check me-0 pe-0 mb-0">
                                                <input type="checkbox" class="form-check-input form-check-input-info mx-0">
                                            </span>
                                        </div>
                                    </div>
                                    <!--/. Task card ends-->
                                    ...
                                    <!-- Task card begins-->
                                    <div
                                        class="card card-body shadow-none bg-primary-subtle border-0 mt-3 mt-lg-5 hover-lift transition-base">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div>
                                                <!--Task date-->
                                                <span class="d-flex align-items-center mb-2 small text-body-secondary"><span class="align-middle me-2 material-symbols-rounded fs-5">
today
                                                ...
                                                <!--Task Heading-->
                                                <h6 class="mb-4 fs-5 fw-medium"><a href="#!.php" class="text-reset">Cupidatat enim ipsum voluptate enim aliquip laboris pariatur</a></h6>
                                            ...
                                            <!--Task checkbox-->
                                            <span class="form-check me-0 pe-0 mb-0">
                                                <input type="checkbox" class="form-check-input form-check-input-primary mx-0">
                                            </span>
                                        </div>
                                    </div>
                                    <!--/. Task card ends-->
...
today
                                                ...
                                                <!--Task Heading-->
                                                <h6 class="mb-4 fs-5 fw-medium"><a href="#!.php" class="text-reset">Exercitation duis officia aute voluptate non nisi quis sint enim eiusmod eiusmod</a></h6>
                            ...
                            <!--Kanban task column-->
                            <div class="tasks mb-7 mb-md-0 col-md-4">
                                <div>
                                    <h6 class="mb-4 text-primary">In Progress (2)</h6>
                                </div>

                                <!--Task In-Progress-->
                                <div id="tasks-inprogress" class="task-list-items">

                                   <!-- Task card begins-->
                                   <div
                                   class="card card-body shadow-none bg-warning-subtle border-0 mt-3 mt-lg-5 hover-lift transition-base">
                                   <div class="d-flex align-items-center justify-content-between">
                                       <div>
                                           <!--Task date-->
                                           <span class="d-flex align-items-center mb-2 small text-body-secondary"><span class="align-middle me-2 material-symbols-rounded fs-5">
today
                                           ...
                                           <!--Task Heading-->
                                           <h6 class="mb-4 fs-5 fw-medium"><a href="#!.php" class="text-reset">Duis aliqua dolore sit dolor et consectetur minim aliqua in et dolore irure consequat.</a></h6>
                                       ...
                                       <!--Task checkbox-->
                                       <span class="form-check me-0 pe-0 mb-0">
                                           <input type="checkbox" class="form-check-input form-check-input-warning mx-0">
                                       </span>
                                   </div>
                               </div>
                               <!--/. Task card ends-->
...
today
                                       ...
                                       <!--Task Heading-->
                                       <h6 class="mb-4 fs-5 fw-medium"><a href="#!.php" class="text-reset">Excepteur pariatur consequat ullamco elit voluptate cillum consequat qui laborum</a></h6>
                           ...
                           <!--/. Task card ends-->
                            ...
                            <div class="tasks col-md-4">
                                <div>
                                    <h6 class="mb-4 text-success">Done (1)</h6>
                                </div>

                                <!--Tasks done-->
                                <div id="tasks-done" class="task-list-items">

                                    <!-- Task card begins-->
                                    <div
                                        class="card card-body shadow-none bg-success-subtle border-0 mt-3 mt-lg-5 hover-lift transition-base">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div>
                                                <!--Task date-->
                                                <span class="d-flex align-items-center mb-2 small text-body-secondary"><span class="align-middle me-2 material-symbols-rounded fs-5">
today
                                                ...
                                                <!--Task Heading-->
                                                <h6 class="mb-4 fs-5 fw-medium"><a href="#!.php" class="text-reset">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default.</a></h6>
                                            ...
                                            <!--Task checkbox-->
                                            <span class="form-check me-0 pe-0 mb-0">
                                                <input type="checkbox" class="form-check-input form-check-input-primary mx-0" checked>
                                            </span>
                                        </div>
                                    </div>
                                    <!--/. Task card ends-->
    ...
    <script src="../../Assets/Dashboard/vendor/dragula.min.js"></script>
