                          ...
                          <li class="nav-item">
                            ...
                            <ul id="component-forms" class="sidebar-dropdown list-unstyled collapse show">
                              ...
                              <li class="sidebar-item"><a class="sidebar-link @@form_stepper" href="ui-form-stepper.php">
                                  Stepper</a></li>
                              <li class="sidebar-item"><a class="sidebar-link active" href="ui-form-upload.php">
                                  Upload</a></li>
                            ...
                            <div class="row align-items-center position-relative">
                                ...
                                <div class="col-md-4 text-md-end">
                                    <a href="https://www.dropzonejs.com/" target="_blank"
                                        class="text-body">Learn more <span class="material-symbols-rounded align-middle ms-1 fs-4">
                                            open_in_new
                                            </span> </a>
                                </div>
                            </div>
